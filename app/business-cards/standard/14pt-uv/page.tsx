...
const UV14Page: React.FC = () => {
  const productId = 7; // Unique ID for 14pt UV
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("UV14Page unmounted");
  }, [productId]);
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <h1 className="text-3xl font-bold text-center mb-8">{productData.name} - 14pt UV Business Cards</h1>
