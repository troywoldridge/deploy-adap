...
const WritableUV14Page: React.FC = () => {
  const productId = 11; // Unique ID for 14pt Writable UV
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("WritableUV14Page unmounted");
  }, [productId]);
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <h1 className="text-3xl font-bold text-center mb-8">{productData.name} - 14pt Writable UV Business Cards</h1>
...
export default WritableUV14Page;
