...
const HardCoverCalendarsPage: React.FC = () => {
  const productId = 63; // Replace with your actual product ID for Self-Cover Calendars
...
export default HardCoverCalendarsPage;
