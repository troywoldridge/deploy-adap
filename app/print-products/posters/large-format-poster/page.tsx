...
const LargeFormatPosterPage: React.FC = () => {
  const productId = 105; // Replace with your actual product ID for 8pt C2S Stock Large Format Poster
...
export default LargeFormatPosterPage;
