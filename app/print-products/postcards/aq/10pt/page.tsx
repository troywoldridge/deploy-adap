...
interface Product {
  ...
  description: string;
  price: string;
  image_url: string; // Primary image (used in index page)
...
const Postcard10ptAQPage: React.FC = () => {
  const productId = 26;
  ...
  // Ensure the primary image URL is absolute.
  ...
  // Use the primary image from the index page as the sole image.
...
export default Postcard10ptAQPage;
