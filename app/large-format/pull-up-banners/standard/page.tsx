...
const StandardBannerPage: React.FC = () => {
  const productId = 103; // Replace with the actual product ID for Standard Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("StandardBannerPage unmounted");
  }, [productId]);
...
export default StandardBannerPage;
