...
const WidePremiumBannerPage: React.FC = () => {
  const productId = 7548; // Replace with the actual product ID for Wide Premium Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("WidePremiumBannerPage unmounted");
  }, [productId]);
...
export default WidePremiumBannerPage;
