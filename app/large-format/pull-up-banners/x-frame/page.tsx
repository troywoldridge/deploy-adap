...
const XFrameBannerPage: React.FC = () => {
  const productId = 111; // Replace with the actual product ID for X-Frame Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("XFrameBannerPage unmounted");
  }, [productId]);
...
export default XFrameBannerPage;
