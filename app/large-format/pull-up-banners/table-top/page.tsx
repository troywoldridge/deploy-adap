...
const TableTopBannerPage: React.FC = () => {
  const productId = 7547; // Replace with the actual product ID for Table-Top Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("TableTopBannerPage unmounted");
  }, [productId]);
...
export default TableTopBannerPage;
