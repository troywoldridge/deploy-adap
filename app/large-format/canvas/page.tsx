...
const coroplastTypes: CoroplastType[] = [
  {
    ...
    alt: "6ft table cover",
    description: "Canvas prints are typically used for photography and canvas art pieces. Our canvas prints on solvent ink printers and the canvas is acid free."
  },
  {
    ...
    description: "These ready-to-use custom canvas prints are stretched over 1.5” wooden frames made from high quality North American basswood."
