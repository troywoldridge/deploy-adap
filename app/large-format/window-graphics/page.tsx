...
// --- COMPONENT ---
const WindowGraphicsPage: React.FC = () => {
  const productId = 206; // Replace with the actual product ID for Window Graphics
  ...
  // Prepare image array for ProductImageGallery
...
export default WindowGraphicsPage;
