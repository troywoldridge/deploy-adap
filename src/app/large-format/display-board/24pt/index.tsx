...
const DisplayBoard24ptPage: React.FC = () => {
  const productId = 107; // Unique ID for Foam Board 4mm Business Cards
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("CustomPage unmounted");
  }, [productId]);
...
export default DisplayBoard24ptPage;
