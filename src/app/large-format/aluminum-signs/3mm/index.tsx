...
const Aluminum3mmPage: React.FC = () => {
  // TODO: Replace with the actual product ID in your database
  const productId = 14978; // Replace with the actual product ID for Aluminum 3mm Signs
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("Aluminum3mmPage unmounted");
  }, [productId]);
...
export default Aluminum3mmPage;
