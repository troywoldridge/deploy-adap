...
const DoubleSidedBannerPage: React.FC = () => {
  const productId = 205; // Replace with the actual product ID for Double-Sided Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("DoubleSidedBannerPage unmounted");
  }, [productId]);
...
export default DoubleSidedBannerPage;
