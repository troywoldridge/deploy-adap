...
const PremiumBannerPage: React.FC = () => {
  const productId = 202; // Replace with the actual product ID for Premium Pull-Up Banner
  ...
  useEffect(() => {
    ...
    getProductData();
    return () => console.log("PremiumBannerPage unmounted");
  }, [productId]);
...
export default PremiumBannerPage;
