  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <p className="mb-8 text-center text-lg text-gray-700">
        Digital Sheets are a cost-effective option for resellers who trim and bind in-house. Get the
        high-quality printing for a variety of products on 18” x 12” Digital Sheets.
      </p>
