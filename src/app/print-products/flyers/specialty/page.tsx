  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      ...
      <div className="max-w-8xl w-full px-4 mb-24">
        <h1 className="text-center text-6xl font-bold mb-6">Specialty Postcards</h1>
        <p className="text-center text-xl font-medium mb-8">
          Discover our unique range of specialty postcards, each crafted with a distinct finish to
          elevate your message. Whether its the luminous shimmer of metallic foil, the eye-catching
          shine of spot UV, the natural charm of kraft paper, the subtle elegance of pearl paper, or
          the enduring quality of our durable collection, every postcard is designed to make a
          lasting impression.
        </p>
