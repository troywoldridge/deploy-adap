  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      ...
      <div className="max-w-8xl w-full px-4 mb-24">
        <h1 className="text-center text-6xl font-bold mb-6">Matte Finish Postcards</h1>
        <p className="text-center text-xl font-medium mb-8">
          Explore our range of high-quality matte finish postcards, perfect for an elegant, velvety
          look and feel.
        </p>
