    ...
    <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      {href ? (
        <Link href={href} legacyBehavior>
          <a className="px-3 py-2 font-bold hover:underline inline-block">{name}</a>
        </Link>
      ) : (
        <button className="px-3 py-2 font-bold hover:underline inline-block">{name}</button>
      )}
                ...
                {link.sublinks && link.sublinks.length > 0 && (
                  <ul className="absolute left-full top-0 mt-0 bg-white text-black shadow-lg rounded-lg border border-gray-200 hidden group-hover:block min-w-[180px]">
                    {link.sublinks.map((subLink, subIndex) => (
                      <li key={subIndex} className="px-4 py-2 hover:bg-gray-100 whitespace-nowrap">
  ...
  },
  {
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [{ label: '14pt Plastics', href: '/print-products/plastics/14pt-plastics' }],
      },
      {
        label: 'Tear Cards',
  ...
  },
  {
    ...
    sublinks: [
      ...
      },
      {
        ...
        sublinks: [{ label: '4mm Foam Board', href: '/large-format/foam-board/4mm-foam-board' }],
      },
      {
        label: 'Banners',
      ...
      },
      {
        ...
        sublinks: [{ label: '4mm Coroplast', href: '/large-format/a-frame/4mm-coroplast-a-frame' }],
      },
      {
        label: 'Wall Decals',
  ...
  },
  {
    ...
    sublinks: [
      ...
      },
      {
        label: 'Glasses',
        href: '/gifts/glasses',
        sublinks: [{ label: '18oz Frosted Drinking Glass', href: '/gifts/glasses/18oz-glass' }],
      },
      {
        label: 'Tumblers',
        href: '/gifts/tumblers',
        sublinks: [{ label: '20oz Skinny Tumbler', href: '/gifts/tumblers/20oz-skinny-tumbler' }],
      },
      {
        label: 'Photo Panels',
        href: '/gifts/photo',
  ...
  return (
    <nav className="relative z-50 bg-gradient-to-r from-blue-600 to-purple-600 text-white flex items-center justify-center space-x-4 py-2">
      {categories.map((cat, idx) => (
        <CategoryItem key={idx} name={cat.name} href={cat.href} sublinks={cat.sublinks} />
      ))}
    </nav>
  )
}
