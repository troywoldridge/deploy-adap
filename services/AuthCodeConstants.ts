...
export class AuthCodeConstants {
  ...
  static readonly TimedOut: string =
    '{"response":{"errors":[{"code":"10400","message":"Request timed out."}]}}'
  static readonly InternalServerError: string =
    '{"response":{"errors":[{"code":"10400","message":"Internal Server error."}]}}'
}
