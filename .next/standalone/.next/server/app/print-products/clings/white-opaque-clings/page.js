;(() => {
  ...
  ;(e.id = 551),
    ...
    (e.modules = {
      ...
      19811: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 92095))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      37646: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'white-opaque-clings',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 97469)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/clings/white-opaque-clings/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/clings/white-opaque-clings/page',
              pathname: '/print-products/clings/white-opaque-clings',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/78', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('WhiteOpaqueClingsPage unmounted')
                }
              ),
              [78]
            ),
      ...
      97469: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/clings/white-opaque-clings/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/clings/white-opaque-clings/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(37646))
  module.exports = s
})()
