;(() => {
  ...
  ;(e.id = 311),
    ...
    (e.modules = {
      ...
      7143: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 50693))
      },
      10846: (e) => {
        'use strict'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/68', {
                    cache: 'no-store',
                  })
      ...
      37407: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 12487))
      },
      39178: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/posters/80lb-enviro-poster/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/posters/80lb-enviro-poster/page',
              pathname: '/print-products/posters/80lb-enviro-poster',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      50693: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/posters/80lb-enviro-poster/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/posters/80lb-enviro-poster/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(39178))
  module.exports = s
})()
