;(() => {
    ...
    (e.modules = {
      2857: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/matte/10pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      11573: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 26459))
      },
      19121: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5541', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('TenPtMattePage unmounted')
                }
              ),
              [5541]
            ),
      ...
      53365: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 2857))
      },
      55511: (e) => {
        'use strict'
      ...
      95402: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/matte/10pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/matte/10pt/page',
              pathname: '/print-products/bookmarks/matte/10pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(95402))
  module.exports = s
})()
