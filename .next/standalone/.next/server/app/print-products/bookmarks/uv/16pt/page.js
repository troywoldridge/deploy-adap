;(() => {
  ...
  ;(e.id = 1815),
    ...
    (e.modules = {
      ...
      13489: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 40805))
      },
      19121: (e) => {
        'use strict'
      ...
      23217: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 90695))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                ...
                () => {
                  console.log('SixteenPtUVPage unmounted')
                }
              ),
              [32]
            ),
      ...
      71908: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/uv/16pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/uv/16pt/page',
              pathname: '/print-products/bookmarks/uv/16pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      90695: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/uv/16pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/uv/16pt/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(71908))
  module.exports = s
})()
