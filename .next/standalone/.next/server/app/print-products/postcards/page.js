;(() => {
    ...
    (t.modules = {
      ...
      25727: (t, r, s) => {
        ...
        let l = [
          ...
          d = () => {
            let t = (r) =>
              (0, e.jsx)('ul', {
                className: 'ml-4 border-l border-gray-300 pl-4 mt-2',
                children: r.map((r, s) =>
                  (0, e.jsxs)(
                    'li',
                    {
                      ...
                      children: [
                        (0, e.jsx)(p(), {
                          ...
                          children: (0, e.jsxs)('div', {
                            className:
                              'flex items-center gap-4 cursor-pointer hover:bg-gray-100 p-2 rounded-lg',
                            children: [
                              (0, e.jsx)(o.default, {
                                src: r.src,
                                alt: r.alt,
            ...
            return (0, e.jsxs)('div', {
              ...
              children: [
                (0, e.jsx)('h1', { className: 'text-4xl font-bold mb-6', children: 'Postcards' }),
                (0, e.jsx)('p', {
      ...
      83192: (t, r, s) => {
        ...
        let n = {
                    ...
                    children: [
                      'postcards',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(s.bind(s, 25727)),
                              '/var/www/deploy-adap/src/app/print-products/postcards/page.tsx',
                            ],
                          },
                        ],
                      },
          ...
          i = ['/var/www/deploy-adap/src/app/print-products/postcards/page.tsx'],
          c = { require: s, loadChunk: () => Promise.resolve() },
          u = new e.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/page',
              pathname: '/print-products/postcards',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  r.C(t)
  var s = (t) => r((r.s = t)),
    e = r.X(0, [1978, 1813, 9203, 3245], () => s(83192))
  module.exports = e
})()
