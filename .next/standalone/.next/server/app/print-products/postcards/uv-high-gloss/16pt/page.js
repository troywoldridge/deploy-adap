    ...
    (e.modules = {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/33', {
                    cache: 'no-store',
                  })
                  if (!e.ok) throw Error(`Fetch failed: ${e.status}`)
                  let r = await e.json()
                  console.log('Options data:', r.options), t(r), d(r.price)
                } catch (e) {
      ...
      30519: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/uv-high-gloss/16pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      49702: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              '16pt',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 30519)),
                                      '/var/www/deploy-adap/src/app/print-products/postcards/uv-high-gloss/16pt/page.tsx',
                                    ],
                                  },
                                ],
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/uv-high-gloss/16pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/uv-high-gloss/16pt/page',
              pathname: '/print-products/postcards/uv-high-gloss/16pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      91263: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 19621))
      },
    })
  var t = require('../../../../../webpack-runtime.js')
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(49702))
  module.exports = s
})()
