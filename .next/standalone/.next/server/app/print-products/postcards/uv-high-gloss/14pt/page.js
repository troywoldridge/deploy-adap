;(() => {
  ...
  ;(e.id = 1735),
    ...
    (e.modules = {
      ...
      11159: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                console.log('Postcard14ptUVHighGlossPage mounted'),
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/20', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard14ptUVHighGlossPage unmounted')
                }
              ),
              [20]
            ),
      ...
      16493: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 71933))
      },
      19121: (e) => {
        'use strict'
      ...
      63757: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 11159))
      },
      71933: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/uv-high-gloss/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      82262: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/uv-high-gloss/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/uv-high-gloss/14pt/page',
              pathname: '/print-products/postcards/uv-high-gloss/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(82262))
  module.exports = s
})()
