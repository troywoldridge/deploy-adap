;(() => {
    ...
    (e.modules = {
      ...
      3389: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/lamination/18pt-gloss/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      7467: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 73527))
      },
      10846: (e) => {
        'use strict'
        ...
        let d = {
                            ...
                            children: [
                              '18pt-gloss',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 3389)),
                                      '/var/www/deploy-adap/src/app/print-products/postcards/lamination/18pt-gloss/page.tsx',
                                    ],
                                  },
                                ],
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/lamination/18pt-gloss/page',
              pathname: '/print-products/postcards/lamination/18pt-gloss',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      73527: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                console.log('Postcard18ptGlossLamPage mounted'),
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/25', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard18ptGlossLamPage unmounted')
                }
              ),
              [25]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(60344))
  module.exports = s
})()
