;(() => {
  ...
  ;(e.id = 116),
    ...
    (e.modules = {
      ...
      21736: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                console.log('Postcard18ptSilkLamPage mounted'),
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/24', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard18ptSilkLamPage unmounted')
                }
              ),
              [24]
            ),
      ...
      49074: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 21736))
      },
      55511: (e) => {
        'use strict'
        ...
        let d = {
                            ...
                            children: [
                              '18pt-silk',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 87202)),
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/lamination/18pt-silk/page',
              pathname: '/print-products/postcards/lamination/18pt-silk',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      87202: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/lamination/18pt-silk/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/lamination/18pt-silk/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(77300))
  module.exports = s
})()
