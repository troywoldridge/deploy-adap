;(() => {
    ...
    (e.modules = {
      2040: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              '10pt',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 55313)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/10pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/matte-finish/10pt/page',
              pathname: '/print-products/postcards/matte-finish/10pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      6379: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 56515))
      },
      10846: (e) => {
        'use strict'
      ...
      55313: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/10pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/10pt/page.tsx',
          'default'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/19', {
                    cache: 'no-store',
                  })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(2040))
  module.exports = s
})()
