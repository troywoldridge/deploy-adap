    ...
    (e.modules = {
      29: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/writable/14pt-writable-uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/104', {
                    cache: 'no-store',
                  })
        ...
        let d = {
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/writable/14pt-writable-uv/page',
              pathname: '/print-products/postcards/writable/14pt-writable-uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      85183: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 54247))
      },
    })
  var t = require('../../../../../webpack-runtime.js')
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(75192))
  module.exports = s
})()
