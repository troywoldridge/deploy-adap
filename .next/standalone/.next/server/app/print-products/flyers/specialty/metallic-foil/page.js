;(() => {
    ...
    (e.modules = {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/7545', {
                    cache: 'no-store',
                  })
            ...
            return (0, s.jsx)('div', {
              className: 'container mx-auto px-4 py-36',
      ...
      29269: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/specialty/metallic-foil/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      36001: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 16891))
      },
      45230: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 29269))
      },
      55511: (e) => {
        'use strict'
        ...
        let d = {
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/flyers/specialty/metallic-foil/page',
              pathname: '/print-products/flyers/specialty/metallic-foil',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(70506))
  module.exports = s
})()
