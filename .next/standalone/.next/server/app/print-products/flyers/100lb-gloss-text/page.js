;(() => {
  ...
  ;(e.id = 6400),
    ...
    (e.modules = {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/37', {
                    cache: 'no-store',
                  })
          ...
          ;(x && x !== `${u}undefined`) || (x = `${u}/flyer-3.png`),
      ...
      28552: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 63060))
      },
      29294: (e) => {
        'use strict'
      ...
      63060: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/100lb-gloss-text/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      86066: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/100lb-gloss-text/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/100lb-gloss-text/page',
              pathname: '/print-products/flyers/100lb-gloss-text',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      92104: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 26618))
      },
    })
  var t = require('../../../../webpack-runtime.js')
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(86066))
  module.exports = s
})()
