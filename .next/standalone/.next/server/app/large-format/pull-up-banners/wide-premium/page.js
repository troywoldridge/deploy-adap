;(() => {
    ...
    (e.modules = {
      ...
      24684: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'wide-premium',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 97400)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/pull-up-banners/wide-premium/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/pull-up-banners/wide-premium/page',
              pathname: '/large-format/pull-up-banners/wide-premium',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      92190: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 96050))
      },
      96050: (e, t, r) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/7548', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('WidePremiumBannerPage unmounted')
              ),
              [7548]
            ),
            c)
      ...
      97400: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/pull-up-banners/wide-premium/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/pull-up-banners/wide-premium/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(24684))
  module.exports = s
})()
