;(() => {
  ...
  ;(e.id = 1272),
    ...
    (e.modules = {
      ...
      25666: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 49748))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/110', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      85334: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/sintra/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      85498: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 85334))
      },
      97344: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/sintra/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/sintra/page',
              pathname: '/large-format/sintra',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(97344))
  module.exports = s
})()
