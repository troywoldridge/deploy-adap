;(() => {
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/4139', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      23074: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'adhesive-vinyl',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 45351)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/adhesive-vinyl/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/adhesive-vinyl/page',
              pathname: '/large-format/adhesive-vinyl',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      45351: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/adhesive-vinyl/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/adhesive-vinyl/page.tsx',
          'default'
      ...
      62667: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 21313))
      },
      63033: (e) => {
        'use strict'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(23074))
  module.exports = s
})()
