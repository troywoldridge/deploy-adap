;(() => {
    ...
    (e.modules = {
      ...
      9023: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/h-stands/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/121', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      14818: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'h-stands',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 9023)),
                              '/var/www/deploy-adap/src/app/large-format/h-stands/page.tsx',
                            ],
                          },
                        ],
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/h-stands/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/h-stands/page',
              pathname: '/large-format/h-stands',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      65583: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 12813))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(14818))
  module.exports = s
})()
