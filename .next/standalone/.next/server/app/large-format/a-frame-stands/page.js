;(() => {
    ...
    (e.modules = {
      ...
      10220: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'a-frame-stands',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 32586)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/a-frame-stands/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/a-frame-stands/page',
              pathname: '/large-format/a-frame-stands',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      32586: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/a-frame-stands/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/a-frame-stands/page.tsx',
          'default'
      ...
      78786: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 85632))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/122', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(10220))
  module.exports = s
})()
