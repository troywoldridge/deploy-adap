      ...
      72140: (e, r, t) => {
        ...
        let x = new n.AppRouteRouteModule({
            definition: {
              ...
              page: '/api/v1/product-image/route',
              pathname: '/api/v1/product-image',
              filename: 'route',
              bundlePath: 'app/api/v1/product-image/route',
            },
            resolvedPagePath: '/var/www/deploy-adap/src/app/api/v1/product-image/route.ts',
