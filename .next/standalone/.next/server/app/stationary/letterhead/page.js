;(() => {
  ...
  ;(e.id = 7048),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/80', {
                      cache: 'no-store',
                    })
      ...
      54990: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 25472))
      },
      55511: (e) => {
        'use strict'
      ...
      85254: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 95638))
      },
      88736: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/stationary/letterhead/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/stationary/letterhead/page',
              pathname: '/stationary/letterhead',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      95638: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/stationary/letterhead/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/stationary/letterhead/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(88736))
  module.exports = s
})()
