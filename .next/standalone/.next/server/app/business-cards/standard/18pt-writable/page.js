;(() => {
  ...
  ;(e.id = 3954),
    ...
    (e.modules = {
      1450: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 88172))
      },
      3295: (e) => {
        'use strict'
      ...
      46380: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/18pt-writable/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/18pt-writable/page',
              pathname: '/business-cards/standard/18pt-writable',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                ...
                () => console.log('Writable18Page unmounted')
              ),
              [12]
            ),
            c)
      ...
      64498: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 50310))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      88172: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/18pt-writable/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/business-cards/standard/18pt-writable/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(46380))
  module.exports = s
})()
