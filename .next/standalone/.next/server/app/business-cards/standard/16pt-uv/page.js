;(() => {
  ...
  ;(e.id = 8227),
    ...
    (e.modules = {
      ...
      19951: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 79695))
      },
      22849: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/16pt-uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      39306: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '16pt-uv',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 22849)),
                                  '/var/www/deploy-adap/src/app/business-cards/standard/16pt-uv/page.tsx',
                                ],
                              },
                            ],
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/16pt-uv/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/16pt-uv/page',
              pathname: '/business-cards/standard/16pt-uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/16', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('UV16Page unmounted')
              ),
              [16]
            ),
            c)
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(39306))
  module.exports = s
})()
