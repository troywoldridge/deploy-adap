;(() => {
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/7', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('UV14Page unmounted')
              ),
              [7]
            ),
            c)
          ...
          return (0, s.jsxs)('div', {
            ...
            children: [
              (0, s.jsxs)('h1', {
                ...
                children: [e.name, ' - 14pt UV Business Cards'],
              }),
              (0, s.jsxs)('div', {
      ...
      47126: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '14pt-uv',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 62675)),
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/14pt-uv/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/14pt-uv/page',
              pathname: '/business-cards/standard/14pt-uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      62675: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/14pt-uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/business-cards/standard/14pt-uv/page.tsx',
          'default'
      ...
      84745: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 1669))
      },
      94473: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 62675))
      },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(47126))
  module.exports = s
})()
