;(() => {
    ...
    (e.modules = {
      ...
      5786: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      36634: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '14pt-writable-uv',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 5786)),
                                  '/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-uv/page.tsx',
                                ],
                              },
                            ],
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-uv/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/14pt-writable-uv/page',
              pathname: '/business-cards/standard/14pt-writable-uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      51830: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 55676))
      },
      55511: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/11', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('WritableUV14Page unmounted')
              ),
              [11]
            ),
            c)
          ...
          return (0, s.jsxs)('div', {
            ...
            children: [
              (0, s.jsxs)('h1', {
                ...
                children: [e.name, ' - 14pt Writable UV Business Cards'],
              }),
              (0, s.jsxs)('div', {
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(36634))
  module.exports = s
})()
