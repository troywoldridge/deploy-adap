          ...
          return (
            ...
            i.with(p.setValue(_, y), () =>
              this.getTracerInstance().startActiveSpan(f, c, (e) => {
                ...
                m && g.set(y, new Map(Object.entries(c.attributes ?? {})))
                try {
...
${t}`
    ...
    71978: (e, t, r) => {
      ...
      function _(e, { workAsyncStorage: t, workUnitAsyncStorage: r }) {
        let u = async (u, f) => {
          ...
          let v
          try {
            ;((v = new URL(u instanceof Request ? u.url : u)).username = ''), (v.password = '')
          } catch {
            v = void 0
          }
          let y = (null == v ? void 0 : v.href) ?? '',
            ...
            R = E ? void 0 : performance.timeOrigin + performance.now(),
            O = t.getStore(),
            P = r.getStore(),
          ...
          let N = (0, a.getTracer)().trace(
            ...
            async () => {
              ...
              let C = null == P ? void 0 : P.implicitTags,
                x = P && 'unstable-cache' === P.type ? 'force-no-store' : O.fetchCache,
                D = !!O.isUnstableNoStore,
                w = v('cache'),
                I = ''
              'string' == typeof w &&
                void 0 !== S &&
                (('force-cache' === w && 0 === S) || ('no-store' === w && (S > 0 || !1 === S))) &&
                ((r = `Specified "cache: ${w}" and "revalidate: ${S}", only one should be specified.`),
                (w = void 0),
                (S = void 0))
              let M =
                  'no-cache' === w ||
                  ...
                  'force-no-store' === x ||
                  'only-no-store' === x,
                j = !x && !w && !S && O.forceDynamic
              'force-cache' === w && void 0 === S
                ? (S = !1)
                : (null == P ? void 0 : P.type) !== 'cache' && (M || j) && (S = 0),
                ('no-cache' === w || 'no-store' === w) && (I = `cache: ${w}`),
                (_ = p(S, O.route))
              let L = v('headers'),
                k = 'function' == typeof (null == L ? void 0 : L.get) ? L : new Headers(L || {}),
                G = k.get('authorization') || k.get('cookie'),
                U = !['get', 'head'].includes(
                  (null == (t = v('method')) ? void 0 : t.toLowerCase()) || 'get'
                ),
                B = void 0 == x && (void 0 == w || 'default' === w) && void 0 == S,
                H = (B && !O.isPrerendering) || ((G || U) && A && 0 === A.revalidate)
              if (B && void 0 !== P && 'prerender' === P.type)
                return (
                  T && (T.endRead(), (T = null)),
              ...
              if (
                ...
                if (0 === _)
                  ...
                  else (0, i.markCurrentScopeAsDynamic)(O, P, `revalidate: 0 fetch ${u} ${O.route}`)
                A && S === _ && (A.revalidate = _)
              }
              let F = 'number' == typeof _ && _ > 0,
                { incrementalCache: V } = O,
                $ =
              ...
              if (V && (F || (null == $ ? void 0 : $.serverComponentsHmrCache)))
                try {
                  n = await V.generateCacheKey(y, m ? u : f)
                } catch (e) {
                        ...
                        if (P && 'prerender' === P.type) {
                          ...
                          return (
                            await V.set(
                              ...
                              { fetchCache: !0, fetchUrl: y, fetchIdx: X, tags: N }
                            ),
                            await q(),
                            new Response(r, {
                              headers: e.headers,
                ...
                if (
                  ...
                  if (
                    ...
                    if (O.isRevalidate && t.isStale) W = !0
                      ...
                      if (t.isStale && ((O.pendingRevalidates ??= {}), !O.pendingRevalidates[n])) {
                        let e = K(!0)
                          .then(async (e) => ({
                          ...
                          .finally(() => {
                            ;(O.pendingRevalidates ??= {}), delete O.pendingRevalidates[n || '']
                          })
              ...
              if (O.isStaticGeneration && f && 'object' == typeof f) {
                ...
                if ('no-store' === e)
                  ...
                  else (0, i.markCurrentScopeAsDynamic)(O, P, `no-store fetch ${u} ${O.route}`)
                let t = 'next' in f,
                  { next: r = {} } = f
                if ('number' == typeof r.revalidate && A && r.revalidate < A.revalidate) {
                  if (0 === r.revalidate)
                    if (P && 'prerender' === P.type)
                      ...
                      (0, i.markCurrentScopeAsDynamic)(O, P, `revalidate: 0 fetch ${u} ${O.route}`)
                  ;(O.forceStatic && 0 === r.revalidate) || (A.revalidate = r.revalidate)
                }
                t && delete f.next
              }
              if (!n || !W) return K(!1, a)
    ...
    88525: (e, t, r) => {
      'use strict'
      e.exports = r(11892).vendored['react-rsc'].React
    },
    89188: (e, t) => {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: !0 }),
