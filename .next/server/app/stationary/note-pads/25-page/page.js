;(() => {
    ...
    (e.modules = {
      ...
      46164: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '25-page',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 65963)),
          ...
          c = ['/var/www/deploy-adap/src/app/stationary/note-pads/25-page/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/stationary/note-pads/25-page/page',
              pathname: '/stationary/note-pads/25-page',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/82', {
                      cache: 'no-store',
                    })
                    if (!e.ok) throw Error(`Fetch failed with status ${e.status}`)
                    let r = await e.json()
                    console.log('Raw product data (25-page):', r), t(r), d(r.price)
                  } catch (e) {
                    e instanceof Error
                      ? console.error('Error fetching product data (25-page):', e)
                      : console.error('Unexpected error:', e),
                      p('Failed to load product data. Please try again later.')
                  }
                })(),
                () => {
                  console.log('Notepad25Page unmounted')
                }
              ),
              [82]
            ),
      ...
      65963: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/stationary/note-pads/25-page/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/stationary/note-pads/25-page/page.tsx',
          'default'
      ...
      83595: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 49781))
      },
      89171: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 65963))
      },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(46164))
  module.exports = s
})()
