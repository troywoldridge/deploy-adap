;(() => {
    ...
    (e.modules = {
      1519: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/stationary/note-pads/50-page/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/83', {
                      cache: 'no-store',
                    })
                    if (!e.ok) throw Error(`Fetch failed with status ${e.status}`)
                    let r = await e.json()
                    console.log('Raw product data (50-page):', r), t(r), d(r.price)
                  } catch (e) {
                    e instanceof Error
      ...
      66816: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '50-page',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 1519)),
                                  '/var/www/deploy-adap/src/app/stationary/note-pads/50-page/page.tsx',
                                ],
                              },
                            ],
          ...
          c = ['/var/www/deploy-adap/src/app/stationary/note-pads/50-page/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/stationary/note-pads/50-page/page',
              pathname: '/stationary/note-pads/50-page',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      76695: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 18021))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(66816))
  module.exports = s
})()
