;(() => {
    ...
    (e.modules = {
      ...
      21664: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'envelopes',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 74595)),
          ...
          c = ['/var/www/deploy-adap/src/app/stationary/envelopes/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/stationary/envelopes/page',
              pathname: '/stationary/envelopes',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/81', {
                      cache: 'no-store',
                    })
      ...
      51673: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 49965))
      },
      55511: (e) => {
        'use strict'
      ...
      74595: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/stationary/envelopes/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/stationary/envelopes/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(21664))
  module.exports = s
})()
