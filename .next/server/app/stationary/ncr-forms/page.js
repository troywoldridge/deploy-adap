;(() => {
    ...
    (e.modules = {
      ...
      14119: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/stationary/ncr-forms/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5547', {
                      cache: 'no-store',
                    })
      ...
      37412: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'ncr-forms',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 14119)),
                              '/var/www/deploy-adap/src/app/stationary/ncr-forms/page.tsx',
                            ],
                          },
                        ],
          ...
          c = ['/var/www/deploy-adap/src/app/stationary/ncr-forms/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/stationary/ncr-forms/page',
              pathname: '/stationary/ncr-forms',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      58881: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 27525))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(37412))
  module.exports = s
})()
