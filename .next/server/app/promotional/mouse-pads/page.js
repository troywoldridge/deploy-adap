;(() => {
  ...
  ;(e.id = 1966),
    ...
    (e.modules = {
      ...
      31740: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 53910))
      },
      33873: (e) => {
        'use strict'
      ...
      53910: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/promotional/mouse-pads/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/1802', {
                      cache: 'no-store',
                    })
      ...
      89884: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 72328))
      },
      94202: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/promotional/mouse-pads/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/promotional/mouse-pads/page',
              pathname: '/promotional/mouse-pads',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(94202))
  module.exports = s
})()
