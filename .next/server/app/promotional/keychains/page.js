;(() => {
    ...
    (e.modules = {
      ...
      19565: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/promotional/keychains/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      28598: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 74655))
      },
      29294: (e) => {
        'use strict'
      ...
      60870: (e, t, r) => {
        ...
        let d = {
                    ...
                    children: [
                      'keychains',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(r.bind(r, 19565)),
                              '/var/www/deploy-adap/src/app/promotional/keychains/page.tsx',
                            ],
                          },
                        ],
          ...
          c = ['/var/www/deploy-adap/src/app/promotional/keychains/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/promotional/keychains/page',
              pathname: '/promotional/keychains',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/1800', {
                      cache: 'no-store',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(60870))
  module.exports = s
})()
