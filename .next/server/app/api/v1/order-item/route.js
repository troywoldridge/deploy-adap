      ...
      71262: (e, r, t) => {
        ...
        let x = new n.AppRouteRouteModule({
            definition: {
              ...
              page: '/api/v1/order-item/route',
              pathname: '/api/v1/order-item',
              filename: 'route',
              bundlePath: 'app/api/v1/order-item/route',
            },
            resolvedPagePath: '/var/www/deploy-adap/src/app/api/v1/order-item/route.ts',
            nextConfigOutput: 'standalone',
            userland: s,
          }),
          { workAsyncStorage: l, workUnitAsyncStorage: v, serverHooks: m } = x
        function j() {
