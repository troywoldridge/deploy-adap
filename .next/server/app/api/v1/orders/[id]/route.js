    ...
    (e.modules = {
      ...
      10919: (e, r, t) => {
        ...
        async function p(e, r) {
          let { id: t } = r.params
          try {
            return u.NextResponse.json({ message: `GET order ${t}` })
          } catch (e) {
            return (
              console.error(e),
        ...
        let l = new n.AppRouteRouteModule({
            definition: {
              ...
              page: '/api/v1/orders/[id]/route',
              pathname: '/api/v1/orders/[id]',
              filename: 'route',
              bundlePath: 'app/api/v1/orders/[id]/route',
            },
            resolvedPagePath: '/var/www/deploy-adap/src/app/api/v1/orders/[id]/route.ts',
