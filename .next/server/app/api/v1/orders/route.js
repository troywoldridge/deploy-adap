      ...
      14965: (e, r, t) => {
        ...
        let x = new n.AppRouteRouteModule({
            definition: {
              ...
              page: '/api/v1/orders/route',
              pathname: '/api/v1/orders',
              filename: 'route',
              bundlePath: 'app/api/v1/orders/route',
            },
            resolvedPagePath: '/var/www/deploy-adap/src/app/api/v1/orders/route.ts',
