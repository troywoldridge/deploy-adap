;(() => {
  ...
  ;(e.id = 3526),
    ...
    (e.modules = {
      ...
      53522: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 84378))
      },
      53852: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/linen/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/1002', {
                      cache: 'no-store',
                    })
      ...
      90474: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 53852))
      },
      91280: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/linen/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/linen/page',
              pathname: '/business-cards/standard/linen',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(91280))
  module.exports = s
})()
