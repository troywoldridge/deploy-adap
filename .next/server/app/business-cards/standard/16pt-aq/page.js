;(() => {
  ...
  ;(e.id = 8090),
    ...
    (e.modules = {
      ...
      20434: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 79038))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      57386: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 96812))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/15', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Aq16Page unmounted')
              ),
              [15]
            ),
            c)
          ...
          return (0, s.jsxs)('div', {
            ...
            children: [
              (0, s.jsxs)('h1', {
                ...
                children: [e.name, ' - 16pt AQ Business Cards'],
              }),
              (0, s.jsxs)('div', {
      ...
      85604: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/16pt-aq/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/16pt-aq/page',
              pathname: '/business-cards/standard/16pt-aq',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      96812: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/16pt-aq/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/business-cards/standard/16pt-aq/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(85604))
  module.exports = s
})()
