;(() => {
  ...
  ;(e.id = 1339),
    ...
    (e.modules = {
      ...
      3851: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 60781))
      },
      10846: (e) => {
        'use strict'
      ...
      26182: (e, t, r) => {
        ...
        let i = ({ productId: e, onOptionsChange: t, onPriceUpdate: r }) => {
          ...
          let x = (e, s) => {
            let a = { ...l, [e]: s }
            d(a), t(a), r && r((100 * Math.random()).toFixed(2))
          }
          return o
            ? (0, s.jsx)('p', { className: 'text-red-500', children: o })
            : p
      ...
      30324: (e, t, r) => {
        ...
        function n({ images: e }) {
          let t = Array.isArray(e) ? e : [],
            [r, n] = (0, a.useState)(t?.[0]?.image_url || '')
          return 0 === t.length
      ...
      43603: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 53003))
      },
      53003: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/14pt-matte/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      60781: (e, t, r) => {
        ...
        let o = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/8', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Matte14Page unmounted')
              ),
              [8]
            ),
            c)
          ...
          let h = e.image_url.startsWith('http')
              ? e.image_url
              : `https://d12ufawtd6351k.cloudfront.net${e.image_url}`,
            m = [{ id: e.id, image_url: h, alt_text: e.name }]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
                className: 'text-3xl font-bold text-center mb-8',
                children: [e.name, ' - 14pt Matte Business Cards'],
              }),
              (0, s.jsxs)('div', {
                className: 'grid grid-cols-1 lg:grid-cols-2 gap-16 mb-8',
                children: [
                  (0, s.jsx)(i.A, { images: m }),
                  (0, s.jsxs)('div', {
                    className: 'space-y-6',
                    children: [
                      (0, s.jsx)(d.A, {
      ...
      62222: (e, t, r) => {
        ...
        let l = i.bL,
          d = a.forwardRef(({ className: e, ...t }, r) =>
            (0, s.jsx)(i.B8, {
              ref: r,
              className: n(
        ...
        d.displayName = 'TabsList'
        let o = a.forwardRef(({ className: e, ...t }, r) =>
          (0, s.jsx)(i.l9, {
            ref: r,
            className: n(
        ...
        let c = a.forwardRef(({ className: e, ...t }, r) =>
          (0, s.jsx)(i.UC, { ref: r, className: n('mt-2', e || ''), ...t })
        )
            ...
            children: [
              (0, s.jsxs)(d, {
                children: [
                  ...
                  (0, s.jsxs)(o, { value: 'reviews', children: ['Reviews (', a, ')'] }),
                ],
              }),
              (0, s.jsx)(c, {
                value: 'details',
      ...
      87596: (e, t, r) => {
        ...
        let o = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/14pt-matte/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/14pt-matte/page',
              pathname: '/business-cards/standard/14pt-matte',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(87596))
  module.exports = s
})()
