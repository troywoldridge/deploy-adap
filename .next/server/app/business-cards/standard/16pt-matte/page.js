;(() => {
  ...
  ;(e.id = 3133),
    ...
    (e.modules = {
      121: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 33409))
      },
      3295: (e) => {
        'use strict'
      ...
      33409: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/16pt-matte/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      36569: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 75679))
      },
      55511: (e) => {
        'use strict'
      ...
      58228: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/16pt-matte/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/16pt-matte/page',
              pathname: '/business-cards/standard/16pt-matte',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/17', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Matte16Page unmounted')
              ),
              [17]
            ),
            c)
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(58228))
  module.exports = s
})()
