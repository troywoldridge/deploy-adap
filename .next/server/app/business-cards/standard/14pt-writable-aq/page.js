;(() => {
  ...
  ;(e.id = 8919),
    ...
    (e.modules = {
      2003: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 42425))
      },
      3295: (e) => {
        'use strict'
      ...
      14096: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '14pt-writable-aq',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 45883)),
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-aq/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/14pt-writable-aq/page',
              pathname: '/business-cards/standard/14pt-writable-aq',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/12', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('WritableAQA14Page unmounted')
              ),
              [12]
            ),
            c)
          ...
          return (0, s.jsxs)('div', {
            ...
            children: [
              (0, s.jsxs)('h1', {
                ...
                children: [e.name, ' - 14pt Writable AQ Business Cards'],
              }),
              (0, s.jsxs)('div', {
      ...
      45883: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-aq/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/business-cards/standard/14pt-writable-aq/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(14096))
  module.exports = s
})()
