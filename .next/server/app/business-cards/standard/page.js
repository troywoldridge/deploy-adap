;(() => {
    ...
    (e.modules = {
            ...
            (0, r.jsxs)('div', {
              ...
              children: [
                (0, r.jsx)('h1', {
                  ...
                  children: 'Standard Business Cards',
                }),
                (0, r.jsx)('div', {
                        ...
                        children: (0, r.jsxs)('div', {
                          ...
                          children: [
                            ...
                            (0, r.jsxs)('div', {
                              className: 'card-body',
                              children: [
                                (0, r.jsx)('h5', { className: 'card-title', children: e.label }),
                                (0, r.jsx)('p', {
                                  className: 'card-text',
      ...
      98618: (e, s, t) => {
        ...
        let o = {
                    ...
                    children: [
                      'standard',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(t.bind(t, 77095)),
                              '/var/www/deploy-adap/src/app/business-cards/standard/page.tsx',
                            ],
                          },
                        ],
                      },
          ...
          p = ['/var/www/deploy-adap/src/app/business-cards/standard/page.tsx'],
          c = { require: t, loadChunk: () => Promise.resolve() },
          u = new r.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/page',
              pathname: '/business-cards/standard',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  s.C(e)
  var t = (e) => s((s.s = e)),
    r = s.X(0, [1978, 1813, 9203, 3245], () => t(98618))
  module.exports = r
})()
