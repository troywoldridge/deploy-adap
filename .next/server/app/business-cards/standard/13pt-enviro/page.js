;(() => {
  ...
  ;(e.id = 6312),
    ...
    (e.modules = {
      ...
      9476: (e, t, r) => {
        ...
        let l = () => {
          let [e, t] = (0, a.useState)(null),
            [r, l] = (0, a.useState)({}),
            [d, c] = (0, a.useState)('0.00'),
            [p, u] = (0, a.useState)(''),
            [h, x] = (0, a.useState)([])
          ;(0, a.useEffect)(() => {
            ;(async () => {
              try {
                let e = await fetch('http://192.168.0.100:8000/api/v1/products/13', {
                  cache: 'no-store',
                })
          ...
          let m = async (e) => {
            ...
            try {
              let t = await fetch('http://192.168.0.100:8000/api/v1/calculateFinalPrice', {
                ...
                r = await t.text()
              if ((console.log('API Response Text:', r), !t.ok))
                throw Error(`Failed to fetch price: ${r}`)
              let s = await t.json()
              console.log('Fetched Price Data:', s),
                s && s.final_price
                  ? c(s.final_price.toFixed(2))
                  : (console.error('No final price returned from API.'), c('0.00'))
            } catch (e) {
              console.error('Error fetching price:', e), c('0.00')
            }
          }
          if (p)
            return (0, s.jsx)('div', {
              className: 'container mx-auto px-4 py-24',
              children: (0, s.jsx)('p', { className: 'text-center text-red-500', children: p }),
            })
          if (!e)
            return (0, s.jsx)('div', {
              className: 'container mx-auto px-4 py-24',
          ...
          let f = e?.pricing?.[0]
          parseFloat(f?.weight_per_box || '0'), parseInt(f?.number_of_boxes || '1')
          let [v, g, b] = f?.box_size?.split(' x ').map(Number) || [0, 0, 0]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
                className: 'text-3xl font-bold text-center mb-8',
                children: [e.name, ' - 13pt Enviro Business Cards'],
              }),
              (0, s.jsxs)('div', {
                className: 'grid grid-cols-1 lg:grid-cols-2 gap-16 mb-8',
                children: [
                  (0, s.jsx)(i.A, { images: e.images }),
                  (0, s.jsxs)('div', {
                    className: 'space-y-6',
                    children: [
                      (0, s.jsx)(n.A, {
      ...
      41200: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 80762))
      },
      43704: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/business-cards/standard/13pt-enviro/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/business-cards/standard/13pt-enviro/page',
              pathname: '/business-cards/standard/13pt-enviro',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      50928: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 9476))
      },
      55511: (e) => {
        'use strict'
      ...
      80762: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/business-cards/standard/13pt-enviro/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/business-cards/standard/13pt-enviro/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 3245], () => r(43704))
  module.exports = s
})()
