;(() => {
  ...
  ;(e.id = 8279),
    ...
    (e.modules = {
      ...
      13664: (e, a, i) => {
        'use strict'
        e.exports = i(65521).getPrototypeOf || null
      },
      14593: (e) => {
        'use strict'
        e.exports =
      ...
      15084: (e, a, i) => {
        ...
        let p = {
            children: [
                ...
                children: [
                  'checkout',
                  {
                    children: [
                      ...
                      {
                        page: [
                          () => Promise.resolve().then(i.bind(i, 23955)),
              ...
              {
                layout: [
                  () => Promise.resolve().then(i.bind(i, 95597)),
                  '/var/www/deploy-adap/src/app/layout.tsx',
                ],
                'not-found': [
                  () => Promise.resolve().then(i.t.bind(i, 55745, 23)),
                  'next/dist/client/components/not-found-error',
                ],
                forbidden: [
                  () => Promise.resolve().then(i.t.bind(i, 33596, 23)),
                  'next/dist/client/components/forbidden-error',
                ],
                unauthorized: [
                  () => Promise.resolve().then(i.t.bind(i, 21869, 23)),
                  'next/dist/client/components/unauthorized-error',
                ],
              },
            ],
          }.children,
          l = ['/var/www/deploy-adap/src/app/checkout/page.tsx'],
      ...
      23955: (e, a, i) => {
        ...
        let n = (0, i(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/checkout/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/checkout/page.tsx',
          'default'
      ...
      24099: (e, a, i) => {
        Promise.resolve().then(i.bind(i, 24454))
      },
      24454: (e, a, i) => {
        'use strict'
        let n
        i.r(a), i.d(a, { default: () => aJ })
        var o,
          t,
          s,
          r = {}
        ...
        let { toString: u } = Object.prototype,
          ...
          S = x('FileList'),
          C = x('URLSearchParams'),
          [O, A, T, F] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(x)
            ...
            function p(e, i, o) {
              ...
              if (e && !o && 'object' == typeof e)
                if (G.endsWith(i, '{}')) (i = n ? i : i.slice(0, -2)), (e = JSON.stringify(e))
                  ...
                  var p
                  if (
                    (G.isArray(e) && ((p = e), G.isArray(p) && !p.some(Y))) ||
              ...
              return !!Y(e) || (a.append(Q(o, i, t), c(e)), !1)
            }
            let l = [],
              u = Object.assign(Z, { defaultVisitor: p, convertValue: c, isVisitable: Y })
        ...
        function et(e, a, i) {
          ...
          let t = i && i.serialize
          if (
            (n = t ? t(a, i) : G.isURLSearchParams(a) ? a.toString() : new ei(a, i).toString(o))
          ) {
            let a = e.indexOf('#')
        ...
        let ep = i(79551).URLSearchParams,
          ...
          ex = 'undefined' != typeof window && 'undefined' != typeof document,
          ef = ('object' == typeof navigator && navigator) || void 0,
          ev = ex && (!ef || 0 > ['ReactNative', 'NativeScript', 'NS'].indexOf(ef.product)),
          eh =
            'undefined' != typeof WorkerGlobalScope &&
            self instanceof WorkerGlobalScope &&
            'function' == typeof self.importScripts,
          eb = (ex && window.location.href) || 'http://localhost',
          eg = { ...r, ...em },
          ey = function (e) {
        ...
        class eO {
          ...
          set(e, a, i) {
            ...
            else if (G.isString(e) && (e = e.trim()) && !eS(e)) t(ej(e), a)
            else if (G.isHeaders(e)) for (let [a, n] of e.entries()) o(n, a, i)
            else null != e && o(a, e, i)
            return this
          }
          get(e, a) {
          ...
          has(e, a) {
            if ((e = eE(e))) {
              let i = G.findKey(this, e)
              return !!(i && void 0 !== this[i] && (!a || eC(this, this[i], i, a)))
            }
            return !1
          }
          delete(e, a) {
            ...
            function o(e) {
              if ((e = eE(e))) {
                let o = G.findKey(i, e)
                o && (!a || eC(i, i[o], o, a)) && (delete i[o], (n = !0))
              }
            }
        ...
        eO.accessor([
          ...
          G.reduceDescriptors(eO.prototype, ({ value: e }, a) => {
        ...
        let { asyncIterator: eV } = Symbol,
          ...
          eY = eg.ALPHABET.ALPHA_DIGIT + '-_',
          eX = 'function' == typeof TextEncoder ? new TextEncoder() : new eB.TextEncoder(),
          eQ = eX.encode('\r\n')
        class eZ {
          constructor(e, a) {
...
`
            n
              ? (a = eX.encode(String(a).replace(/\r?\n|\r\n?/g, '\r\n')))
              : (o += `Content-Type: ${a.type || 'application/octet-stream'}\r
`),
              (this.headers = eX.encode(o + '\r\n')),
        ...
        let e0 = (e, a, i) => {
          let {
            ...
            size: o = 25,
            boundary: t = n + '-' + eg.generateString(o, eY),
          } = i || {}
            ...
            function (e) {
              return ac(async function (a, i, n) {
                let o,
                  ...
                  { responseType: x, responseEncoding: f } = e,
                ...
                if ('data:' === k) {
                  ...
                  try {
                    ...
                    })(e.url, 'blob' === x, { Blob: e.env && e.env.Blob })
                  } catch (a) {
                    throw $.from(a, $.ERR_BAD_REQUEST, e)
                  }
                  return (
                    'text' === x
                      ? ((n = n.toString(f)), (f && 'utf8' !== f) || (n = G.stripBOM(n)))
                      : 'stream' === x && (n = eW.Readable.from(n)),
                    ez(a, i, {
                      data: n,
                      status: 200,
                      statusText: 'OK',
                ...
                if (-1 === ao.indexOf(k))
                  return i(new $('Unsupported protocol ' + k, $.ERR_BAD_REQUEST, e))
                let j = eO.from(e.headers).normalize()
                j.set('User-Agent', 'axios/' + eD, !1)
                ...
                if (G.isSpecCompliantForm(u)) {
                  ...
                  if ((j.set(u.getHeaders()), !j.hasContentLength()))
                    try {
                      let e = await eB.promisify(u.getLength).call(u)
                      Number.isFinite(e) && e >= 0 && j.setContentLength(e)
                    } catch (e) {}
                } else if (G.isBlob(u) || G.isFile(u))
                  u.size && j.setContentType(u.type || 'application/octet-stream'),
                ...
                let S = G.toFiniteNumber(j.getContentLength())
                ...
                j.set('Accept-Encoding', 'gzip, compress, deflate' + (ae ? ', br' : ''), !1)
                let C = {
                  path: p,
                  method: v,
                  headers: j.toJSON(),
                ...
                G.isUndefined(d) || (C.lookup = d),
                  e.socketPath
                    ...
                    : ((C.hostname = w.hostname.startsWith('[')
                      ...
                      })(C, e.proxy, k + '//' + w.hostname + (w.port ? ':' + w.port : '') + C.path))
                let O = an.test(C.protocol)
                if (
                  ...
                  e.transport
                    ...
                    : 0 === e.maxRedirects
                      ...
                      : (e.maxRedirects && (C.maxRedirects = e.maxRedirects),
                        e.beforeRedirect && (C.beforeRedirects.config = e.beforeRedirect),
                        (l = O ? ai : aa)),
                  e.maxBodyLength > -1
                    ? (C.maxBodyLength = e.maxBodyLength)
                    : (C.maxBodyLength = 1 / 0),
                  e.insecureHTTPParser && (C.insecureHTTPParser = e.insecureHTTPParser),
                  (c = l.request(C, function (n) {
                    ...
                    let l = eW.finished(r, () => {
                      ...
                      u = {
                        ...
                        headers: new eO(n.headers),
                        config: e,
                        request: p,
                      }
                    if ('stream' === x) (u.data = r), ez(a, i, u)
                    else {
                      let n = [],
                        o = 0
                      r.on('data', function (a) {
                        ...
                        r.on('end', function () {
                          try {
                            ...
                            'arraybuffer' !== x &&
                              ((e = e.toString(f)), (f && 'utf8' !== f) || (e = G.stripBOM(e))),
                              (u.data = e)
                          } catch (a) {
        ...
        let av = (e) => {
          ...
          ah =
            ...
            function (e) {
              return new Promise(function (a, i) {
                ...
                function v() {
                  if (!f) return
                  let n = eO.from('getAllResponseHeaders' in f && f.getAllResponseHeaders())
                  ez(
                    function (e) {
                      a(e), x()
                    },
                ...
                f.open(c.method.toUpperCase(), c.url, !0),
                  (f.timeout = c.timeout),
                  'onloadend' in f
                    ? (f.onloadend = v)
                  ...
                  (f.onabort = function () {
                    f && (i(new $('Request aborted', $.ECONNABORTED, e, f)), (f = null))
                  }),
                  (f.onerror = function () {
                    i(new $('Network Error', $.ERR_NETWORK, e, f)), (f = null)
                  }),
                  (f.ontimeout = function () {
                    ...
                    c.timeoutErrorMessage && (a = c.timeoutErrorMessage),
                      i(new $(a, n.clarifyTimeoutError ? $.ETIMEDOUT : $.ECONNABORTED, e, f)),
                      (f = null)
                  }),
                  ...
                  G.isUndefined(c.withCredentials) || (f.withCredentials = !!c.withCredentials),
                  u && 'json' !== u && (f.responseType = c.responseType),
                  m && (([t, r] = e6(m, !0)), f.addEventListener('progress', t)),
                  d &&
                    f.upload &&
                    (([o, s] = e6(d)),
                    f.upload.addEventListener('progress', o),
                    f.upload.addEventListener('loadend', s)),
                  (c.cancelToken || c.signal) &&
                    ((n = (a) => {
                      f && (i(!a || a.type ? new eF(null, e, f) : a), f.abort(), (f = null))
                    }),
          ...
          a_ = aj && 'function' == typeof ReadableStream,
          aE =
            aj &&
          ...
          aC = a_ && aR(() => G.isReadableStream(new Response('').body)),
          aO = { stream: aC && ((e) => e.body) }
        aj &&
          ((s = new Response()),
          ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach((e) => {
            aO[e] ||
              (aO[e] = G.isFunction(s[e])
                ? (a) => a[e]()
                : (a, i) => {
          ...
          aF = {
            ...
            fetch:
              ...
              (async (e) => {
                ...
                let f = ab([s, r && r.toAbortSignal()], c),
                  v =
                    f &&
                    f.unsubscribe &&
                    (() => {
                ...
                try {
                  ...
                  u = u || 'text'
                  let h = await aO[G.findKey(aO, u) || 'text'](r, e)
                  return (
                    !c && v && v(),
                    await new Promise((i, n) => {
                      ez(i, n, {
                        data: h,
                        headers: eO.from(r.headers),
                        status: r.status,
                  ...
                  if ((v && v(), i && 'TypeError' === i.name && /fetch/i.test(i.message)))
                  ...
                  return (
                    !eT(a) &&
                      ...
                      a &&
                        ...
                        (a.response.headers = eO.from(a.response.headers)))),
                    Promise.reject(a)
                  )
                }
              )
        ...
        let aN = {}
        ;(aB.transitional = function (e, a, i) {
          function n(e, a) {
        ...
        class aM {
          ...
          _request(e, a) {
            ...
            let { transitional: o, paramsSerializer: t, headers: s } = (a = af(this.defaults, a))
            void 0 !== o &&
              aI.assertOptions(
                o,
                {
          ...
          getUri(e) {
            return et(
              eP((e = af(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
              e.params,
              e.paramsSerializer
            )
          }
        ...
        G.forEach(['delete', 'get', 'head', 'options'], function (e) {
          aM.prototype[e] = function (a, i) {
            return this.request(af(i || {}, { method: e, url: a, data: (i || {}).data }))
          }
        }),
        ...
        let aJ = () => {
          let e = (0, a$.useRouter)(),
            [a, i] = (0, p.useState)({ address: '', city: '', state: '', zip: '' }),
            [n, o] = (0, p.useState)('standard'),
            [t, s] = (0, p.useState)(''),
            [r, l] = (0, p.useState)([]),
            [u, d] = (0, p.useState)(null),
            [m, x] = (0, p.useState)(!1),
            [f, v] = (0, p.useState)(null)
          ;(0, p.useEffect)(() => {
            ;(async () => {
              try {
                let e = await aG.get('/api/cart')
                l(e.data)
              } catch {
                v('Failed to load cart items')
              }
            })()
          }, [])
          let h = async () => {
              if (!a.zip) return void v('Please enter a ZIP code.')
              x(!0)
              try {
                let e = await aG.post('/api/checkout/calculate-shipping', {
                  zip: a.zip,
                  weight: r.reduce((e, a) => e + a.product.weight * a.quantity, 0),
                  length: 10,
                  width: 10,
                  height: 10,
                })
                ...
                v('Failed to calculate shipping rates')
              } finally {
                x(!1)
              }
            },
            b = async () => {
              if (!t) return void v('Payment method is required')
              x(!0)
              try {
                let i = await aG.post('/api/checkout/process', {
                  shipping_address: a,
                  shipping_method: n,
                  payment_method: 'credit_card',
                  payment_token: t,
                })
                e.push(`/order/${i.data.order.id}`)
              } catch {
                v('Failed to process checkout')
              } finally {
                x(!1)
              }
            }
          return (0, c.jsxs)('div', {
            ...
            children: [
              ...
              f && (0, c.jsx)('div', { className: 'error', children: f }),
              (0, c.jsx)('div', {
                className: 'cart-items',
                children:
                  0 === r.length
                    ? (0, c.jsx)('p', { children: 'Your cart is empty.' })
                    : r.map((e) =>
                        (0, c.jsxs)(
                          'div',
                          {
                            className: 'cart-item',
                            children: [
                              (0, c.jsx)('p', { children: e.product.name }),
                              (0, c.jsxs)('p', {
                                children: ['Price: $', e.product.price.toFixed(2)],
                              }),
                              (0, c.jsxs)('p', { children: ['Quantity: ', e.quantity] }),
                            ],
                          },
                          e.id
                        )
              ...
              (0, c.jsx)('h2', { children: 'Shipping Address' }),
              (0, c.jsx)('input', {
                type: 'text',
                value: a.address,
                onChange: (e) => i({ ...a, address: e.target.value }),
                placeholder: 'Address',
              }),
              (0, c.jsx)('input', {
                type: 'text',
                value: a.city,
                onChange: (e) => i({ ...a, city: e.target.value }),
                placeholder: 'City',
              }),
              (0, c.jsx)('input', {
                type: 'text',
                value: a.state,
                onChange: (e) => i({ ...a, state: e.target.value }),
                placeholder: 'State',
              }),
              (0, c.jsx)('input', {
                type: 'text',
                value: a.zip,
                onChange: (e) => i({ ...a, zip: e.target.value }),
                placeholder: 'ZIP Code',
              }),
              (0, c.jsx)('button', {
                onClick: h,
                disabled: m,
                children: m ? 'Calculating Shipping...' : 'Calculate Shipping',
              }),
              u &&
                (0, c.jsxs)('div', {
                  className: 'shipping-options',
                  children: [
                    (0, c.jsx)('h3', { children: 'Available Shipping Methods' }),
                    u.map((e, a) =>
                      (0, c.jsxs)(
                        'div',
                        {
              ...
              (0, c.jsx)('button', {
                onClick: b,
                disabled: m,
                children: m ? 'Processing Order...' : 'Complete Purchase',
              }),
            ],
          })
        }
      ...
      43983: (e, a, i) => {
        'use strict'
        var n = i(58448)('%Object.defineProperty%', !0),
          o = i(74145)(),
          t = i(66522),
          s = i(25434),
      ...
      47430: (e, a, i) => {
        e.exports = { parallel: i(96831), serial: i(17396), serialOrdered: i(39075) }
      },
      47984: (e) => {
        'use strict'
        e.exports = Math.min
      ...
      58448: (e, a, i) => {
        ...
        var L = function e(a) {
          ...
          q = i(30084),
          B = i(66522),
          N = q.call(A, Array.prototype.concat),
          I = q.call(O, Array.prototype.splice),
          D = q.call(A, String.prototype.replace),
          M = q.call(A, String.prototype.slice),
          H = q.call(A, RegExp.prototype.exec),
          W =
            /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
          G = /\\(\\)?/g,
          $ = function (e) {
        ...
        e.exports = function (e, a) {
          ...
          for (var u = 1, d = !0; u < i.length; u += 1) {
            ...
            if ((('constructor' !== m && d) || (r = !0), (n += '.' + m), B(z, (t = '%' + n + '%'))))
              s = z[t]
            else if (null != s) {
              if (!(m in s)) {
                if (!a)
      ...
      71876: (e, a, i) => {
        ...
        var x = S('ERR_INVALID_URL', 'Invalid URL', TypeError),
          f = S('ERR_FR_REDIRECTION_FAILURE', 'Redirected request failed'),
          v = S('ERR_FR_TOO_MANY_REDIRECTS', 'Maximum number of redirects exceeded', f),
        ...
        function y(e, a) {
          ...
          ;(this._onNativeResponse = function (e) {
            try {
              ...
              i.emit('error', e instanceof f ? e : new f({ cause: e }))
            }
          }),
        ...
        function j(e) {
          var a
          if (l) a = new o(e)
          else if (!O((a = _(n.parse(e))).protocol)) throw new x({ input: e })
          return a
        }
        function _(e) {
          if (
        ...
        ;(y.prototype = Object.create(r.prototype)),
          ...
          (y.prototype._processResponse = function (e) {
            ...
            x && (u = Object.assign({ Host: e.req.getHeader('host') }, this._options.headers))
            var f = this._options.method
            ...
            var h = R(/^host$/i, this._options.headers),
              ...
              w = ((a = m), (i = y), l ? new o(a, i) : j(n.resolve(i, a)))
            if (
              ...
              var k = { headers: e.headers, statusCode: d },
                _ = { url: y, method: f, headers: u }
              x(this._options, k, _), this._sanitizeOptions(this._options)
            }
            this._performRequest()
          }),
      ...
      72526: (e, a, i) => {
        ...
        function c(e, a = {}) {
          ...
          return (
            0 !==
              (i = (function (e, { streamIsTTY: a, sniffFlags: i = !0 } = {}) {
                let t = (function () {
                  if ('FORCE_COLOR' in r)
                    return 'true' === r.FORCE_COLOR
                      ? 1
                      : 'false' === r.FORCE_COLOR
                        ? 0
                ...
                if (e && !a && void 0 === c) return 0
                let p = c || 0
                if ('dumb' === r.TERM) return p
      ...
      89569: (e, a, i) => {
        ...
        ;(e.exports = f),
          ...
          (f.prototype.append = function (e, a, i) {
          ...
          (f.prototype._trackLength = function (e, a, i) {
            var n = 0
            null != i.knownLength
              ? (n += +i.knownLength)
              : Buffer.isBuffer(a)
          ...
          (f.prototype._multiPartHeader = function (e, a, i) {
            ...
            for (var c in ('object' == typeof i.header && x(r, i.header), r))
              if (Object.prototype.hasOwnProperty.call(r, c)) {
                ...
                Array.isArray(n) || (n = [n]),
                  n.length && (s += c + ': ' + n.join('; ') + f.LINE_BREAK)
              }
          ...
          (f.prototype._getContentType = function (e, a) {
            ...
            return (
              ...
              i || 'object' != typeof e || (i = f.DEFAULT_CONTENT_TYPE),
              i
            )
          }),
          ...
          (f.prototype.submit = function (e, a) {
            ...
            return (
              'string' == typeof e
                ...
                : (n = x(e, o)).port || (n.port = 'https:' == n.protocol ? 443 : 80),
  ...
  a.C(e)
  var i = (e) => a((a.s = e)),
    n = a.X(0, [7920, 1813, 3245], () => i(15084))
  module.exports = n
})()
