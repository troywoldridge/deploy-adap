;(() => {
  ...
  ;(e.id = 7978),
    ...
    (e.modules = {
      ...
      29342: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 83500))
      },
      30324: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => n })
      ...
      34070: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 55786))
      },
      55511: (e) => {
        'use strict'
      ...
      55786: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/clings/transparent-clings/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      77110: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/clings/transparent-clings/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/clings/transparent-clings/page',
              pathname: '/print-products/clings/transparent-clings',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/77', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('TransparentClingsPage unmounted')
                }
              ),
              [77]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(77110))
  module.exports = s
})()
