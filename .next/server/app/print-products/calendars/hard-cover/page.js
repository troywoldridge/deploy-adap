;(() => {
    ...
    (e.modules = {
      ...
      23282: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'hard-cover',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 78039)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/calendars/hard-cover/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/calendars/hard-cover/page',
              pathname: '/print-products/calendars/hard-cover',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      64025: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 68813))
      },
      68813: (e, t, r) => {
        'use strict'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/63', {
                    cache: 'no-store',
                  })
      ...
      78039: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/calendars/hard-cover/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/calendars/hard-cover/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(23282))
  module.exports = s
})()
