;(() => {
    ...
    (e.modules = {
      ...
      13864: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '80lb-enviro',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 99296)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/80lb-enviro/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/80lb-enviro/page',
              pathname: '/print-products/flyers/80lb-enviro',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      79142: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 93986))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/40', {
                    cache: 'no-store',
                  })
          ...
          let u = 'https://d12ufawtd6351k.cloudfront.net',
            x = e.image_url?.startsWith('http') ? e.image_url : `${u}${e.image_url}`
          ;(x && x !== `${u}undefined`) || (x = `${u}/enviro-flyer-1.webp`),
            console.log('Final Image URL:', x)
          let h = [{ id: e.id, image_url: x, alt_text: e.name }]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
      ...
      99296: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/80lb-enviro/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/flyers/80lb-enviro/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(13864))
  module.exports = s
})()
