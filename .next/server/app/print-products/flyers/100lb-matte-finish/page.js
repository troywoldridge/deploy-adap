;(() => {
  ...
  ;(e.id = 4097),
    ...
    (e.modules = {
      ...
      10509: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 47607))
      },
      10846: (e) => {
        'use strict'
      ...
      46893: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 99477))
      },
      47607: (e, t, r) => {
        'use strict'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/39', {
                    cache: 'no-store',
                  })
          ...
          let u = 'https://d12ufawtd6351k.cloudfront.net',
            h = e.image_url?.startsWith('http') ? e.image_url : `${u}${e.image_url}`
          ;(h && h !== `${u}undefined`) || (h = `${u}/flyer-2.png`),
            console.log('Final Image URL:', h)
          let x = [{ id: e.id, image_url: h, alt_text: e.name }]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
      ...
      48772: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/100lb-matte-finish/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/100lb-matte-finish/page',
              pathname: '/print-products/flyers/100lb-matte-finish',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      99477: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/100lb-matte-finish/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/flyers/100lb-matte-finish/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(48772))
  module.exports = s
})()
