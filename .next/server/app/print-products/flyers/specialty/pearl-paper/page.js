;(() => {
    ...
    (e.modules = {
      ...
      16716: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              'pearl-paper',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 39624)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/specialty/pearl-paper/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/specialty/pearl-paper/page',
              pathname: '/print-products/flyers/specialty/pearl-paper',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      39624: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/specialty/pearl-paper/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/flyers/specialty/pearl-paper/page.tsx',
          'default'
      ...
      73012: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 82858))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/7543', {
                    cache: 'no-store',
                  })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(16716))
  module.exports = s
})()
