;(() => {
    ...
    (e.modules = {
      ...
      12263: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/specialty/spot-uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      77387: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 4077))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      82963: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 12263))
      },
      99118: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/specialty/spot-uv/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/specialty/spot-uv/page',
              pathname: '/print-products/flyers/specialty/spot-uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(99118))
  module.exports = s
})()
