;(() => {
    ...
    (e.modules = {
      ...
      49496: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              'durable',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 67960)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/specialty/durable/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/specialty/durable/page',
              pathname: '/print-products/flyers/specialty/durable',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      59464: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 79794))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
      ...
      67960: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/specialty/durable/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/flyers/specialty/durable/page.tsx',
          'default'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/7546', {
                    cache: 'no-store',
                  })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(49496))
  module.exports = s
})()
