;(() => {
    ...
    (e.modules = {
      ...
      22682: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '70lb-linen',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 49606)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/flyers/70lb-linen/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/flyers/70lb-linen/page',
              pathname: '/print-products/flyers/70lb-linen',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/41', {
                    cache: 'no-store',
                  })
      ...
      49606: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/flyers/70lb-linen/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/flyers/70lb-linen/page.tsx',
          'default'
      ...
      58734: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 32352))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(22682))
  module.exports = s
})()
