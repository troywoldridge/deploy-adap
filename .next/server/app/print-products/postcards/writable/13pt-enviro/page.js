;(() => {
  ...
  ;(e.id = 5485),
    ...
    (e.modules = {
      ...
      24111: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 55667))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      32359: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 97325))
      },
      33873: (e) => {
        'use strict'
        ...
        let d = {
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/writable/13pt-enviro/page',
              pathname: '/print-products/postcards/writable/13pt-enviro',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      55667: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/writable/13pt-enviro/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/writable/13pt-enviro/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(41430))
  module.exports = s
})()
