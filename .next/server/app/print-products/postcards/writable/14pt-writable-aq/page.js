;(() => {
  ...
  ;(e.id = 5072),
    ...
    (e.modules = {
      1250: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 90966))
      },
      1976: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/writable/14pt-writable-aq/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
        ...
        let d = {
                            ...
                            children: [
                              '14pt-writable-aq',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 1976)),
                                      '/var/www/deploy-adap/src/app/print-products/postcards/writable/14pt-writable-aq/page.tsx',
                                    ],
                                  },
                                ],
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/writable/14pt-writable-aq/page',
              pathname: '/print-products/postcards/writable/14pt-writable-aq',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(21834))
  module.exports = s
})()
