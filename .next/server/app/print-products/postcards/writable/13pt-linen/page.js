;(() => {
    ...
    (e.modules = {
      ...
      3544: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/writable/13pt-linen/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
        ...
        let d = {
                            ...
                            children: [
                              '13pt-linen',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 3544)),
                                      '/var/www/deploy-adap/src/app/print-products/postcards/writable/13pt-linen/page.tsx',
                                    ],
                                  },
                                ],
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/postcards/writable/13pt-linen/page',
              pathname: '/print-products/postcards/writable/13pt-linen',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      25242: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 56446))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(15602))
  module.exports = s
})()
