;(() => {
  ...
  ;(e.id = 5730),
    ...
    (e.modules = {
      ...
      7708: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 77402))
      },
      10846: (e) => {
        'use strict'
      ...
      53222: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/aq/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/aq/14pt/page',
              pathname: '/print-products/postcards/aq/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      65852: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 77408))
      },
      77402: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/aq/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/aq/14pt/page.tsx',
          'default'
      ...
      77408: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                console.log('Postcard14ptAQPage mounted'),
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/18', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard14ptAQPage unmounted')
                }
              ),
              [18]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(53222))
  module.exports = s
})()
