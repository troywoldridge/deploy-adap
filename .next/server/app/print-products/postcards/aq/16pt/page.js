;(() => {
  ...
  ;(e.id = 3880),
    ...
    (e.modules = {
      ...
      11738: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 36116))
      },
      14882: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/aq/16pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/aq/16pt/page',
              pathname: '/print-products/postcards/aq/16pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      36116: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/aq/16pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/aq/16pt/page.tsx',
          'default'
      ...
      51906: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 55246))
      },
      55246: (e, t, r) => {
        'use strict'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                console.log('Postcard16ptAQPage mounted'),
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/32', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard16ptAQPage unmounted')
                }
              ),
              [32]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(14882))
  module.exports = s
})()
