;(() => {
    ...
    (e.modules = {
      ...
      18830: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/aq/10pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      38640: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 18830))
      },
      55511: (e) => {
        'use strict'
      ...
      73478: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/aq/10pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/aq/10pt/page',
              pathname: '/print-products/postcards/aq/10pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      73488: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 98860))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/26', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('Postcard10ptAQPage unmounted')
                }
              ),
              [26]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(73478))
  module.exports = s
})()
