;(() => {
    ...
    (e.modules = {
      ...
      9848: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              '14pt',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 14613)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/matte-finish/14pt/page',
              pathname: '/print-products/postcards/matte-finish/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      14613: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/14pt/page.tsx',
          'default'
      ...
      35159: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 80567))
      },
      55511: (e) => {
        'use strict'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(9848))
  module.exports = s
})()
