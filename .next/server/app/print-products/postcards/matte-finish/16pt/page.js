;(() => {
    ...
    (e.modules = {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/34', {
                    cache: 'no-store',
                  })
            ...
            return (0, s.jsx)('p', { children: 'Loading...' })
          let c = e.image_url.startsWith('http')
              ? e.image_url
              : `https://d12ufawtd6351k.cloudfront.net${e.image_url}`,
            p = [{ id: e.id, image_url: c, alt_text: e.name }]
          return (0, s.jsxs)('div', {
      ...
      22223: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/16pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      54981: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 18501))
      },
      55511: (e) => {
        'use strict'
      ...
      84024: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/postcards/matte-finish/16pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/postcards/matte-finish/16pt/page',
              pathname: '/print-products/postcards/matte-finish/16pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(84024))
  module.exports = s
})()
