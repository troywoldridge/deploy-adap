;(() => {
  ...
  ;(e.id = 5030),
    ...
    (e.modules = {
      ...
      34397: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 68759))
      },
      39133: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 82325))
      },
      49660: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          u = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/print-products/bookmarks/standard/lamination/gloss/page',
              pathname: '/print-products/bookmarks/standard/lamination/gloss',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      82325: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/standard/lamination/gloss/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/standard/lamination/gloss/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(49660))
  module.exports = s
})()
