;(() => {
  ...
  ;(e.id = 9746),
    ...
    (e.modules = {
      ...
      5688: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 43646))
      },
      10846: (e) => {
        'use strict'
      ...
      14342: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/lamination/silk/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/lamination/silk/page',
              pathname: '/print-products/bookmarks/lamination/silk',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      15416: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 38168))
      },
      19121: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/30', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('LaminationSilkPage unmounted')
                }
              ),
              [30]
            ),
      ...
      43646: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/lamination/silk/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/lamination/silk/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(14342))
  module.exports = s
})()
