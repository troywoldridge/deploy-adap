;(() => {
    ...
    (e.modules = {
      ...
      29722: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              '16pt',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 94407)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/matte/16pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/matte/16pt/page',
              pathname: '/print-products/bookmarks/matte/16pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      44923: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 87357))
      },
      55511: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5538', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('SixteenPtMattePage unmounted')
                }
              ),
              [5538]
            ),
      ...
      94407: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/matte/16pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/matte/16pt/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(29722))
  module.exports = s
})()
