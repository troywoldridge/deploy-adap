;(() => {
  ...
  ;(e.id = 2747),
    ...
    (e.modules = {
      ...
      25177: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 26477))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      26477: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/matte/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      38329: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 72495))
      },
      55511: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5529', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('FourteenPtMattePage unmounted')
                }
              ),
              [5529]
            ),
      ...
      81738: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/matte/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/matte/14pt/page',
              pathname: '/print-products/bookmarks/matte/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(81738))
  module.exports = s
})()
