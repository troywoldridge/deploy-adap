;(() => {
    ...
    (e.modules = {
      ...
      24508: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              'enviro',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 56538)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/enviro/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/specialty/enviro/page',
              pathname: '/print-products/bookmarks/specialty/enviro',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      25410: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 67044))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      56538: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/enviro/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/enviro/page.tsx',
          'default'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5535', {
                      cache: 'no-store',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(24508))
  module.exports = s
})()
