;(() => {
  ...
  ;(e.id = 378),
    ...
    (e.modules = {
      ...
      8652: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 44794))
      },
      10846: (e) => {
        'use strict'
      ...
      36300: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/uv-c1s/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5534', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('UVC1SPage unmounted')
                }
              ),
              [5534]
            ),
      ...
      55296: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/uv-c1s/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/specialty/uv-c1s/page',
              pathname: '/print-products/bookmarks/specialty/uv-c1s',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(55296))
  module.exports = s
})()
