;(() => {
    ...
    (e.modules = {
      ...
      6275: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/linen/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      48281: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 6275))
      },
      55511: (e) => {
        'use strict'
      ...
      61433: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 67473))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/5539', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('LinenPage unmounted')
                }
              ),
              [5539]
            ),
      ...
      89932: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/specialty/linen/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/specialty/linen/page',
              pathname: '/print-products/bookmarks/specialty/linen',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(89932))
  module.exports = s
})()
