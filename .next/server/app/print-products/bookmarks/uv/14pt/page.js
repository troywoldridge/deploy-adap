;(() => {
    ...
    (e.modules = {
      ...
      18596: (e, t, r) => {
        ...
        let d = {
                            ...
                            children: [
                              '14pt',
                              {
                                children: [
                                  ...
                                  {
                                    page: [
                                      () => Promise.resolve().then(r.bind(r, 22765)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/bookmarks/uv/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/bookmarks/uv/14pt/page',
              pathname: '/print-products/bookmarks/uv/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      22765: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/bookmarks/uv/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/bookmarks/uv/14pt/page.tsx',
          'default'
      ...
      77555: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 99959))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/31', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('FourteenPtUVPage unmounted')
                }
              ),
              [31]
            ),
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(18596))
  module.exports = s
})()
