;(() => {
    ...
    (e.modules = {
      ...
      32101: (e, r, t) => {
        ...
        let s = (0, t(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/greeting-cards/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      46705: (e, r, t) => {
        Promise.resolve().then(t.bind(t, 89743))
      },
      47377: (e, r, t) => {
      ...
      48066: (e, r, t) => {
        ...
        let l = {
          ...
          p = ['/var/www/deploy-adap/src/app/print-products/greeting-cards/page.tsx'],
          c = { require: t, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/greeting-cards/page',
              pathname: '/print-products/greeting-cards',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  r.C(e)
  var t = (e) => r((r.s = e)),
    s = r.X(0, [7920, 1813, 3245], () => t(48066))
  module.exports = s
})()
