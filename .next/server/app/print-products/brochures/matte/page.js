;(() => {
    ...
    (e.modules = {
      ...
      20500: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'matte',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 37417)),
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/brochures/matte/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/brochures/matte/page',
              pathname: '/print-products/brochures/matte',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/45', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('MatteBrochurePage unmounted')
                }
              ),
              [45]
            ),
      ...
      37417: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/brochures/matte/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/print-products/brochures/matte/page.tsx',
          'default'
      ...
      72701: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 33063))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(20500))
  module.exports = s
})()
