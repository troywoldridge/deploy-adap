;(() => {
    ...
    (e.modules = {
      ...
      7881: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/brochures/uv/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      19499: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 51095))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/44', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('UVBrochurePage unmounted')
                }
              ),
              [44]
            ),
      ...
      57538: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'uv',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 7881)),
                                  '/var/www/deploy-adap/src/app/print-products/brochures/uv/page.tsx',
                                ],
                              },
                            ],
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/brochures/uv/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/brochures/uv/page',
              pathname: '/print-products/brochures/uv',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(57538))
  module.exports = s
})()
