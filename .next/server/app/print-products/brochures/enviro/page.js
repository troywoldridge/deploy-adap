;(() => {
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/46', {
                      cache: 'no-store',
                    })
                ...
                () => {
                  console.log('EnviroBrochurePage unmounted')
                }
              ),
              [46]
            ),
      ...
      11991: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/brochures/enviro/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      13837: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 7225))
      },
      19121: (e) => {
        'use strict'
      ...
      73517: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 11991))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      91410: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/brochures/enviro/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/brochures/enviro/page',
              pathname: '/print-products/brochures/enviro',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(91410))
  module.exports = s
})()
