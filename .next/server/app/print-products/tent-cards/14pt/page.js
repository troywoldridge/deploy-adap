;(() => {
    ...
    (e.modules = {
      ...
      5523: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/print-products/tent-cards/14pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      13503: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 5523))
      },
      19121: (e) => {
        'use strict'
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(() => {
              ;(async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/4902', {
                    cache: 'no-store',
                  })
      ...
      50455: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 41641))
      },
      55511: (e) => {
        'use strict'
      ...
      97476: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/print-products/tent-cards/14pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/print-products/tent-cards/14pt/page',
              pathname: '/print-products/tent-cards/14pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(97476))
  module.exports = s
})()
