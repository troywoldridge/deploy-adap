;(() => {
  ...
  ;(e.id = 3401),
    ...
    (e.modules = {
      ...
      7733: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 97579))
      },
      10846: (e) => {
        'use strict'
      ...
      21301: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 31937))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      58478: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/banners/13oz-gloss/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/banners/13oz-gloss/page',
              pathname: '/large-format/banners/13oz-gloss',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      97579: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/banners/13oz-gloss/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/banners/13oz-gloss/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(58478))
  module.exports = s
})()
