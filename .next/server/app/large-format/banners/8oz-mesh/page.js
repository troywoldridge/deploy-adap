    ...
    (e.modules = {
      ...
      20092: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/banners/8oz-mesh/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      60674: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 20092))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/101', {
                      cache: 'no-store',
                    })
      ...
      92428: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/banners/8oz-mesh/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/banners/8oz-mesh/page',
              pathname: '/large-format/banners/8oz-mesh',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      95178: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 91258))
      },
    })
  var t = require('../../../../webpack-runtime.js')
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(92428))
  module.exports = s
})()
