;(() => {
  ...
  ;(e.id = 2967),
    ...
    (e.modules = {
      ...
      12795: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 62531))
      },
      16969: (e, t, r) => {
        'use strict'
      ...
      23411: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 16969))
      },
      26182: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => i })
      ...
      33404: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/coroplast/4mm/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/coroplast/4mm/page',
              pathname: '/large-format/coroplast/4mm',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      62531: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/coroplast/4mm/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/coroplast/4mm/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(33404))
  module.exports = s
})()
