;(() => {
    ...
    (e.modules = {
      ...
      7988: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '8mm',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 59263)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/coroplast/8mm/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/coroplast/8mm/page',
              pathname: '/large-format/coroplast/8mm',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      8311: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 54477))
      },
      10846: (e) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/99', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Coroplast8mmPage unmounted')
              ),
              [99]
            ),
            c)
      ...
      59263: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/coroplast/8mm/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/coroplast/8mm/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(7988))
  module.exports = s
})()
