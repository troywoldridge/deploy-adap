;(() => {
  ...
  ;(e.id = 5132),
    ...
    (e.modules = {
      ...
      17364: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 33832))
      },
      19121: (e) => {
        'use strict'
      ...
      26182: (e, t, r) => {
        ...
        let i = ({ productId: e, onOptionsChange: t, onPriceUpdate: r }) => {
          ...
          let m = (e, s) => {
            let a = { ...l, [e]: s }
            n(a), t(a), r && r((100 * Math.random()).toFixed(2))
          }
          return d
      ...
      33832: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/14975', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Coroplast10mmPage unmounted')
              ),
              [14975]
            ),
            c)
          ...
          let u = e.image_url.startsWith('http')
            ...
            m = [{ id: e.id, image_url: u, alt_text: e.name }]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
      ...
      41332: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 97590))
      },
      52388: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/coroplast/10mm/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/coroplast/10mm/page',
              pathname: '/large-format/coroplast/10mm',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      62222: (e, t, r) => {
        ...
        let l = i.bL,
          n = a.forwardRef(({ className: e, ...t }, r) =>
            (0, s.jsx)(i.B8, {
              ref: r,
              className: o(
          ...
          return (
            ...
            (0, s.jsxs)('div', {
              children: [
                ...
                (0, s.jsxs)('p', { children: ['New Price: ', n] }),
              ],
            })
          )
        }
      ...
      97590: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/coroplast/10mm/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/coroplast/10mm/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(52388))
  module.exports = s
})()
