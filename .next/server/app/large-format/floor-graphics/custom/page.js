;(() => {
  ...
  ;(e.id = 55),
    ...
    (e.modules = {
      ...
      6815: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 97385))
      },
      10846: (e) => {
        'use strict'
      ...
      15032: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          'custom',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 74019)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/floor-graphics/custom/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/floor-graphics/custom/page',
              pathname: '/large-format/floor-graphics/custom',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      74019: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/floor-graphics/custom/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/floor-graphics/custom/page.tsx',
          'default'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/14676', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(15032))
  module.exports = s
})()
