;(() => {
  ...
  ;(e.id = 2642),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/112', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      54108: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 86438))
      },
      55511: (e) => {
        'use strict'
      ...
      59318: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/a-frame/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/a-frame/page',
              pathname: '/large-format/a-frame',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      63836: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 51524))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      86438: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/a-frame/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/a-frame/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(59318))
  module.exports = s
})()
