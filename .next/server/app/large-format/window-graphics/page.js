;(() => {
  ...
  ;(e.id = 2743),
    ...
    (e.modules = {
      ...
      6217: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 87860))
      },
      10846: (e) => {
        'use strict'
      ...
      30216: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/window-graphics/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/window-graphics/page',
              pathname: '/large-format/window-graphics',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      48073: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 92341))
      },
      55511: (e) => {
        'use strict'
      ...
      87860: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/window-graphics/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/window-graphics/page.tsx',
          'default'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/206', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(30216))
  module.exports = s
})()
