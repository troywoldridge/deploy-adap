;(() => {
  ...
  ;(e.id = 2505),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/107', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      42013: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 71995))
      },
      55511: (e) => {
        'use strict'
      ...
      69629: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 26133))
      },
      71995: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/display-board/24pt/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      96570: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/display-board/24pt/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/display-board/24pt/page',
              pathname: '/large-format/display-board/24pt',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(96570))
  module.exports = s
})()
