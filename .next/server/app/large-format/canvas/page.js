;(() => {
    ...
    (e.modules = {
        ...
        let i = [
          ...
          d = () =>
            (0, s.jsxs)('div', {
              ...
              children: [
                (0, s.jsx)('h1', { className: 'mb-4 text-center', children: 'Canvas' }),
                (0, s.jsx)('div', {
      ...
      41174: (e, r, t) => {
        ...
        let l = {
                    ...
                    children: [
                      'canvas',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(t.bind(t, 8953)),
                              '/var/www/deploy-adap/src/app/large-format/canvas/page.tsx',
                            ],
                          },
                        ],
                      },
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/canvas/page.tsx'],
          p = { require: t, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/canvas/page',
              pathname: '/large-format/canvas',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  r.C(e)
  var t = (e) => r((r.s = e)),
    s = r.X(0, [7920, 1813, 9203, 3245], () => t(41174))
  module.exports = s
})()
