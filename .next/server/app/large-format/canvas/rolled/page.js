;(() => {
  ...
  ;(e.id = 9550),
    ...
    (e.modules = {
      ...
      29970: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 33558))
      },
      30324: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => l })
      ...
      33558: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/canvas/rolled/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      73070: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/canvas/rolled/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/canvas/rolled/page',
              pathname: '/large-format/canvas/rolled',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      93178: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 98320))
      },
      98320: (e, t, r) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/109', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(73070))
  module.exports = s
})()
