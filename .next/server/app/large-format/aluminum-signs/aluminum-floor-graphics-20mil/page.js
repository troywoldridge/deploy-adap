;(() => {
  ...
  ;(e.id = 3685),
    ...
    (e.modules = {
      1841: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 94011))
      },
      3295: (e) => {
        'use strict'
        ...
        let d = {
          ...
          p = new s.AppPageRouteModule({
            definition: {
              ...
              page: '/large-format/aluminum-signs/aluminum-floor-graphics-20mil/page',
              pathname: '/large-format/aluminum-signs/aluminum-floor-graphics-20mil',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/302', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('AluminumFloorGraphicsPage unmounted')
              ),
              [302]
            ),
            c)
      ...
      92113: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 83917))
      },
      94011: (e, t, r) => {
        'use strict'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(65858))
  module.exports = s
})()
