;(() => {
    ...
    (e.modules = {
                      ...
                      'div',
                      {
                        children: [
                          ...
                          (0, s.jsxs)('select', {
                            ...
                            onChange: (t) => m(e.group, parseInt(t.target.value)),
                            value: l[e.group] || '',
                            children: [
                              (0, s.jsxs)('option', {
                                value: '',
      ...
      41292: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '3mm',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 83560)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/aluminum-signs/3mm/page.tsx'],
          u = { require: r, loadChunk: () => Promise.resolve() },
          p = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/aluminum-signs/3mm/page',
              pathname: '/large-format/aluminum-signs/3mm',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      62222: (e, t, r) => {
        ...
        let u = ({ description: e, attributes: t, rating: r, reviewCount: a }) =>
          (0, s.jsxs)(l, {
      ...
      71566: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 99001))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      83560: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/aluminum-signs/3mm/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/aluminum-signs/3mm/page.tsx',
          'default'
      ...
      99001: (e, t, r) => {
        ...
        let d = () => {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/14978', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('Aluminum3mmPage unmounted')
              ),
              [14978]
            ),
            c)
          ...
          let p = e.image_url.startsWith('http')
            ...
            m = [{ id: e.id, image_url: p, alt_text: e.name }]
          return (0, s.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
            children: [
              (0, s.jsxs)('h1', {
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(41292))
  module.exports = s
})()
