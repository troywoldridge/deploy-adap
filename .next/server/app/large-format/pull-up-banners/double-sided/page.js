;(() => {
    ...
    (e.modules = {
      ...
      7206: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/pull-up-banners/double-sided/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/205', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('DoubleSidedBannerPage unmounted')
              ),
              [205]
            ),
            c)
      ...
      33272: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 27356))
      },
      33873: (e) => {
        'use strict'
      ...
      36120: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/pull-up-banners/double-sided/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/pull-up-banners/double-sided/page',
              pathname: '/large-format/pull-up-banners/double-sided',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(36120))
  module.exports = s
})()
