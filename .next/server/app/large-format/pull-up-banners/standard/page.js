    ...
    (e.modules = {
      ...
      4470: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/pull-up-banners/standard/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      24104: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 4470))
      },
      26084: (e, t, r) => {
        'use strict'
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/103', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('StandardBannerPage unmounted')
              ),
              [103]
            ),
            c)
      ...
      61680: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/pull-up-banners/standard/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/pull-up-banners/standard/page',
              pathname: '/large-format/pull-up-banners/standard',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      87656: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 26084))
      },
    })
  var t = require('../../../../webpack-runtime.js')
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(61680))
  module.exports = s
})()
