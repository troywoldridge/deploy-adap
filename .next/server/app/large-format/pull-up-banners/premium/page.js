;(() => {
  ...
  ;(e.id = 522),
    ...
    (e.modules = {
      ...
      44134: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 59096))
      },
      49686: (e, t, r) => {
        'use strict'
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/pull-up-banners/premium/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/202', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('PremiumBannerPage unmounted')
              ),
              [202]
            ),
            c)
      ...
      61438: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 49686))
      },
      62222: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => p })
      ...
      75558: (e, t, r) => {
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/pull-up-banners/premium/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/pull-up-banners/premium/page',
              pathname: '/large-format/pull-up-banners/premium',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(75558))
  module.exports = s
})()
