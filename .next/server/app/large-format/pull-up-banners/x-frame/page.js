;(() => {
  ...
  ;(e.id = 6503),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/111', {
                      cache: 'no-store',
                    })
                ...
                () => console.log('XFrameBannerPage unmounted')
              ),
              [111]
            ),
            c)
      ...
      35751: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 30865))
      },
      45908: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
                        ...
                        children: [
                          'x-frame',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 51939)),
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/pull-up-banners/x-frame/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/pull-up-banners/x-frame/page',
              pathname: '/large-format/pull-up-banners/x-frame',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      51939: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/pull-up-banners/x-frame/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/pull-up-banners/x-frame/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [7920, 1813, 7242, 3245], () => r(45908))
  module.exports = s
})()
