;(() => {
  ...
  ;(e.id = 6033),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/14988', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      34933: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 84439))
      },
      37250: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/table-covers/8ft/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/table-covers/8ft/page',
              pathname: '/large-format/table-covers/8ft',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      76789: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 24401))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
      ...
      84439: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/table-covers/8ft/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/table-covers/8ft/page.tsx',
          'default'
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(37250))
  module.exports = s
})()
