;(() => {
  ...
  ;(e.id = 6003),
    ...
    (e.modules = {
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/14987', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
      ...
      68411: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 71945))
      },
      68506: (e, t, r) => {
        'use strict'
        r.r(t),
        ...
        let d = {
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/table-covers/6ft/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/table-covers/6ft/page',
              pathname: '/large-format/table-covers/6ft',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      71945: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/table-covers/6ft/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
          '/var/www/deploy-adap/src/app/large-format/table-covers/6ft/page.tsx',
          'default'
      ...
      79027: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 50727))
      },
      79297: (e, t, r) => {
        'use strict'
        r.d(t, { A: () => a })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(68506))
  module.exports = s
})()
