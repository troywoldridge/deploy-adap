;(() => {
    ...
    (e.modules = {
        ...
        let n = [
          ...
          d = () =>
            (0, s.jsxs)('div', {
              ...
              children: [
                (0, s.jsx)('h1', { className: 'mb-4 text-center', children: 'Foam Board' }),
                (0, s.jsx)('div', {
      ...
      93070: (e, r, t) => {
        ...
        let l = {
                    ...
                    children: [
                      'foam-board',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(t.bind(t, 75197)),
                              '/var/www/deploy-adap/src/app/large-format/foam-board/page.tsx',
                            ],
                          },
                        ],
                      },
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/foam-board/page.tsx'],
          p = { require: t, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/foam-board/page',
              pathname: '/large-format/foam-board',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
  ...
  r.C(e)
  var t = (e) => r((r.s = e)),
    s = r.X(0, [1978, 1813, 9203, 3245], () => t(93070))
  module.exports = s
})()
