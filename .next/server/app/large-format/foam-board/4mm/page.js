;(() => {
    ...
    (e.modules = {
      3116: (e, t, r) => {
        ...
        let s = (0, r(56968).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/var/www/deploy-adap/src/app/large-format/foam-board/4mm/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.'
            )
          },
      ...
      12538: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 64454))
      },
      19121: (e) => {
        'use strict'
      ...
      45276: (e, t, r) => {
        ...
        let d = {
                        ...
                        children: [
                          '4mm',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(r.bind(r, 3116)),
                                  '/var/www/deploy-adap/src/app/large-format/foam-board/4mm/page.tsx',
                                ],
                              },
                            ],
          ...
          c = ['/var/www/deploy-adap/src/app/large-format/foam-board/4mm/page.tsx'],
          p = { require: r, loadChunk: () => Promise.resolve() },
          u = new s.AppPageRouteModule({
            definition: {
              kind: a.RouteKind.APP_PAGE,
              page: '/large-format/foam-board/4mm/page',
              pathname: '/large-format/foam-board/4mm',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
          ...
          if (
            ((0, a.useEffect)(
              () => (
                (async () => {
                  try {
                    let e = await fetch('http://192.168.0.100:8000/api/v1/products/100', {
                      cache: 'no-store',
                      mode: 'cors',
                    })
  ...
  t.C(e)
  var r = (e) => t((t.s = e)),
    s = t.X(0, [1978, 1813, 7242, 3245], () => r(45276))
  module.exports = s
})()
