            ...
            226: function (o, n) {
              !(function (a, s) {
                ...
                var u = 'function',
                  ...
                  W = function (e, i) {
                    return typeof e === d && -1 !== F(i).indexOf(F(e))
                  },
                  F = function (e) {
                    ...
                    for (var t in i)
                      if (typeof i[t] === l && i[t].length > 0) {
                        for (var r = 0; r < i[t].length; r++)
                          if (W(i[t][r], e)) return '?' === t ? s : t
                      } else if (W(i[t], e)) return '?' === t ? s : t
                    return e
                  },
                  Q = {
                    ME: '4.90',
                    ...
                    return (
                      (this.getBrowser = function () {
                        ...
                        return (
                          ...
                          v && t && t.brave && typeof t.brave.isBrave == u && (i[p] = 'Brave'),
                          i
                        )
                      }),
                      ...
                      (this.getEngine = function () {
                        var e = {}
                        return (e[p] = s), (e[h] = s), J.call(e, r, n.engine), e
                      }),
                      (this.getOS = function () {
                        var e = {}
                        return (
                          ...
                          v &&
                            ...
                            o &&
                            'Unknown' != o.platform &&
                            (e[p] = o.platform.replace(/chrome os/i, H).replace(/macos/i, $)),
                          e
                        )
                      }),
                ...
                ;(ee.VERSION = '1.0.35'),
                  (ee.BROWSER = V([p, h, b])),
                  (ee.CPU = V([g])),
                  (ee.DEVICE = V([w, m, f, v, y, k, x, _, R])),
                  (ee.ENGINE = ee.OS = V([p, h])),
                  typeof n !== c
