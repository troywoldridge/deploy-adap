;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [401],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(7547), {
                    cache: 'no-store',
                  })
    ...
    78487: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 54691))
    },
  },
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(78487)), (_N_E = e.O())
  },
])
