;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3010],
  {
    ...
    31546: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 41496))
    },
    41496: (e, t, s) => {
      'use strict'
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(7548), {
                    cache: 'no-store',
                  })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(31546)), (_N_E = e.O())
  },
])
