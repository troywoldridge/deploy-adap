;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6003],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(14987), {
                    cache: 'no-store',
                    mode: 'cors',
                  })
    ...
    53005: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 14997))
    },
    72094: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => i })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(53005)), (_N_E = e.O())
  },
])
