;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9769],
  {
    ...
    36437: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 80907))
    },
    48213: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => r })
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(4139), {
                    cache: 'no-store',
                    mode: 'cors',
                  })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(36437)), (_N_E = e.O())
  },
])
