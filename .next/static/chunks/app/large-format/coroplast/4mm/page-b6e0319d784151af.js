  ...
  [2967],
  {
      ...
      let u = (e) => {
        ...
        return (0, a.jsxs)(n, {
          ...
          children: [
            (0, a.jsxs)(c, {
              children: [
                (0, a.jsx)(d, { value: 'details', children: 'Details' }),
                (0, a.jsxs)(d, { value: 'reviews', children: ['Reviews (', l, ')'] }),
              ],
            }),
            (0, a.jsx)(o, {
              value: 'details',
    ...
    20298: (e, t, s) => {
      ...
      let l = (e) => {
        ...
        let x = (e, t) => {
          let a = { ...c, [e]: t }
          d(a), s(a), l && l((100 * Math.random()).toFixed(2))
        }
        return o
          ? (0, a.jsx)('p', { className: 'text-red-500', children: o })
          : p
    ...
    48213: (e, t, s) => {
      ...
      let r = (e) => {
        ...
        let { pricing: s, selectedOptions: r, basePrice: l, finalPrice: i } = e,
          ...
          d = n.find((e) => e.option_hash === c),
          o = null != (t = null == d ? void 0 : d.base_price) ? t : l
        return (
          ...
          (0, a.jsxs)('div', {
            children: [
              ...
              (0, a.jsxs)('p', { children: ['New Price: ', o] }),
            ],
          })
        )
      }
      ...
      let d = () => {
        ...
        if (
          ((0, r.useEffect)(() => {
            ;(async () => {
              try {
                let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(99), {
                  cache: 'no-store',
                })
          ...
          return (0, a.jsx)('div', {
            ...
            children: (0, a.jsx)('p', { className: 'text-center text-red-500', children: o }),
          })
        if (!e)
          return (0, a.jsx)('div', {
            className: 'container mx-auto px-4 py-24',
        ...
        let x = e.image_url.startsWith('http')
            ? e.image_url
            : ''.concat('https://d12ufawtd6351k.cloudfront.net').concat(e.image_url),
          m = [{ id: e.id, image_url: x, alt_text: e.name }]
        return (
          e.pricing[0],
          (0, a.jsxs)('div', {
            className: 'container mx-auto px-4 py-24',
    ...
    72094: (e, t, s) => {
      ...
      function i(e) {
        ...
        let { images: i } = e,
          n = Array.isArray(i) ? i : [],
          [c, d] = (0, r.useState)((null == n || null == (t = n[0]) ? void 0 : t.image_url) || '')
        return 0 === n.length
    ...
    82605: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 59033))
    },
  },
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(82605)), (_N_E = e.O())
  },
])
