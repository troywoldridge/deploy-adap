;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5132],
  {
    ...
    51996: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 93306))
    },
    72094: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => i })
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(14975), {
                    cache: 'no-store',
                  })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(51996)), (_N_E = e.O())
  },
])
