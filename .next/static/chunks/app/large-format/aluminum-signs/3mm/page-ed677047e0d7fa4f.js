;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2854],
  {
    ...
    19402: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 97116))
    },
    20298: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => l })
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(14978), {
                    cache: 'no-store',
                  })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(19402)), (_N_E = e.O())
  },
])
