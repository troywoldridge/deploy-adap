;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3526],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(1002), {
                    cache: 'no-store',
                  })
    ...
    87534: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 21532))
    },
  },
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(87534)), (_N_E = e.O())
  },
])
