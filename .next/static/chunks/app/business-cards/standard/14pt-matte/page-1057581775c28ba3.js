;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1339],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(8), {
                    cache: 'no-store',
                  })
          ...
          return (0, s.jsx)('div', {
            ...
            children: (0, s.jsx)('p', { className: 'text-center text-red-500', children: o }),
          })
        if (!e)
          return (0, s.jsx)('div', {
            className: 'container mx-auto px-4 py-24',
          ...
          children: [
            (0, s.jsxs)(c, {
              children: [
                ...
                (0, s.jsxs)(d, { value: 'reviews', children: ['Reviews (', l, ')'] }),
              ],
            }),
            (0, s.jsx)(o, {
              value: 'details',
    ...
    20298: (e, t, a) => {
      ...
      let l = (e) => {
        ...
        let x = (e, t) => {
          let s = { ...c, [e]: t }
          d(s), a(s), l && l((100 * Math.random()).toFixed(2))
        }
        return o
    ...
    67701: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 3229))
    },
    72094: (e, t, a) => {
      'use strict'
      a.d(t, { A: () => i })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(67701)), (_N_E = e.O())
  },
])
