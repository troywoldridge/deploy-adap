;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4097],
  {
    ...
    17931: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 49139))
    },
    20298: (e, t, a) => {
      'use strict'
      a.d(t, { A: () => l })
      ...
      let o = () => {
        ...
        if (
          ((0, r.useEffect)(() => {
            ;(async () => {
              try {
                let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(39), {
                  cache: 'no-store',
                })
        ...
        ;(x && x !== ''.concat(h, 'undefined')) || (x = ''.concat(h, '/flyer-2.png')),
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(17931)), (_N_E = e.O())
  },
])
