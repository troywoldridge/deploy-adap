  ...
  [8553],
  {
      ...
      let c = () => {
        ...
        if (
          ((0, r.useEffect)(() => {
            ;(async () => {
              try {
                let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(33), {
                  cache: 'no-store',
                })
                if (!e.ok) throw Error('Fetch failed: '.concat(e.status))
                let s = await e.json()
                console.log('Options data:', s.options), t(s), c(s.price)
              } catch (e) {
          ...
          return (0, a.jsx)('p', { children: 'Loading...' })
        let d = e.image_url.startsWith('http')
            ? e.image_url
            : ''.concat('https://d12ufawtd6351k.cloudfront.net').concat(e.image_url),
          u = [{ id: e.id, image_url: d, alt_text: e.name }]
        return (0, a.jsxs)('div', {
      ...
      let u = (e) => {
        ...
        return (0, a.jsxs)(n, {
          ...
          children: [
            (0, a.jsxs)(o, {
              children: [
                (0, a.jsx)(c, { value: 'details', children: 'Details' }),
                (0, a.jsxs)(c, { value: 'reviews', children: ['Reviews (', l, ')'] }),
              ],
            }),
            (0, a.jsx)(d, {
              value: 'details',
    ...
    20298: (e, t, s) => {
      ...
      let l = (e) => {
        ...
        let x = (e, t) => {
          let a = { ...o, [e]: t }
          c(a), s(a), l && l((100 * Math.random()).toFixed(2))
        }
        return d
    ...
    92537: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 9659))
    },
  },
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(92537)), (_N_E = e.O())
  },
])
