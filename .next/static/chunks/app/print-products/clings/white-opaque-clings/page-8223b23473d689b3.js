;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [551],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(78), {
                    cache: 'no-store',
                  })
                  if (!e.ok) throw Error('Fetch failed with status '.concat(e.status))
                  let s = await e.json()
                  console.log('Raw product data:', s), t(s), o(s.price)
                } catch (e) {
    ...
    41629: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 12841))
    },
    48213: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => r })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(41629)), (_N_E = e.O())
  },
])
