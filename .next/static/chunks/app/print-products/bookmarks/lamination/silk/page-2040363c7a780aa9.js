;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9746],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(30), {
                    cache: 'no-store',
                  })
                  if (!e.ok) throw Error('Fetch failed with status '.concat(e.status))
                  let a = await e.json()
                  console.log('Raw product data:', a), t(a), c(a.price)
                } catch (e) {
                  e instanceof Error
    ...
    92256: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 66808))
    },
  },
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(92256)), (_N_E = e.O())
  },
])
