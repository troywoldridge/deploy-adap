;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2747],
  {
        ...
        if (
          ((0, r.useEffect)(
            () => (
              (async () => {
                try {
                  let e = await fetch('http://192.168.0.100:8000/api/v1/products/'.concat(5529), {
                    cache: 'no-store',
                  })
                  if (!e.ok) throw Error('Fetch failed with status '.concat(e.status))
                  let s = await e.json()
                  console.log('Raw product data:', s), t(s), c(s.price)
                } catch (e) {
                  e instanceof Error
    ...
    68967: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 55821))
    },
    72094: (e, t, s) => {
      'use strict'
      s.d(t, { A: () => i })
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, [9460, 4073, 3623, 6605, 7358], () => t(68967)), (_N_E = e.O())
  },
])
