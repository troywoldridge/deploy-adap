    ...
    83: (e, t, r) => {
      ...
      function y(e) {
        let t,
          r,
          n,
          [i, y] = (0, u.useOptimistic)(p.IDLE_LINK_STATUS),
          b = (0, u.useRef)(null),
          {
            href: P,
            as: E,
        ...
        let K = L ? r && 'object' == typeof r && r.ref : U,
          B = u.default.useCallback(
            (e) => (
              null !== w && (b.current = (0, p.mountLinkInstance)(e, D, w, R, M, y)),
              () => {
                b.current &&
          ...
          z = {
            ...
            onMouseEnter(e) {
              L || 'function' != typeof S || S(e),
                ...
                w && M && (0, p.onNavigationIntent)(e.currentTarget, !0 === I)
            },
        ...
        return (
          ...
          (n = L ? u.default.cloneElement(r, z) : (0, o.jsx)('a', { ...k, ...z, children: t })),
